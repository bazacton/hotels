...
if ( isset( $_POST['payment_status'] ) && $_POST['payment_status'] == 'Completed'  && 
	...
	if(isset($booking_id) && !empty($booking_id)){
		...
		if(isset($_POST['txn_id']) && $_POST['txn_id'] <> ''){
			...
			//$transaction_array['subscr_id']    = esc_attr($_POST['subscr_id']); // Subscription method parameter
			//$subs_booking_array['subscr_date'] 	= 	esc_attr($_POST['subscr_date']); // Subscription method parameter
		...
		if(isset($_POST['reattempt']) && $_POST['reattempt'] <> ''){
			...
			//$subs_booking_array['subscr_id']    = 	esc_attr($_POST['subscr_id']); // Subscription method parameter
			//$subs_booking_array['subscr_date'] 	= 	esc_attr($_POST['subscr_date']); // Subscription method parameter
