...
global $cs_theme_options , $cs_plugin_options;

$cs_plugin_options = get_option('cs_plugin_options');
$cs_theme_options = get_option('cs_theme_options');

$cs_plugin_options['cs_reservation']=isset($cs_plugin_options['cs_reservation']) ? $cs_plugin_options['cs_reservation']:'';
$cs_plugin_options['cs_allow_user_booking']=isset($cs_plugin_options['cs_allow_user_booking']) ? $cs_plugin_options['cs_allow_user_booking']:'';
$cs_plugin_options['cs_rooms_booking_type']=isset($cs_plugin_options['cs_rooms_booking_type']) ? $cs_plugin_options['cs_rooms_booking_type']:'';
$cs_plugin_options['cs_min_booking']=isset($cs_plugin_options['cs_min_booking']) ? $cs_plugin_options['cs_min_booking']:'';
$cs_plugin_options['cs_advnce_deposit']=isset($cs_plugin_options['cs_advnce_deposit']) ? $cs_plugin_options['cs_advnce_deposit']:'';
$cs_plugin_options['cs_allow_full_pay']=isset($cs_plugin_options['cs_allow_full_pay']) ? $cs_plugin_options['cs_allow_full_pay']:'';
$cs_plugin_options['cs_thank_title']=isset($cs_plugin_options['cs_thank_title']) ? $cs_plugin_options['cs_thank_title']:'';
$cs_plugin_options['cs_confir_phone']=isset($cs_plugin_options['cs_confir_phone']) ? $cs_plugin_options['cs_confir_phone']:'';
$cs_plugin_options['cs_confir_fax']=isset($cs_plugin_options['cs_confir_fax']) ? $cs_plugin_options['cs_confir_fax']:'';
$cs_plugin_options['cs_confir_email']=isset($cs_plugin_options['cs_confir_email']) ? $cs_plugin_options['cs_confir_email']:'';
$cs_plugin_options['cs_thank_msg']=isset($cs_plugin_options['cs_thank_msg']) ? $cs_plugin_options['cs_thank_msg']:'';
$cs_plugin_options['cs_total_rooms']=isset($cs_plugin_options['cs_total_rooms']) ? $cs_plugin_options['cs_total_rooms']:'';
$cs_plugin_options['cs_language_file']=isset($cs_plugin_options['cs_language_file']) ? $cs_plugin_options['cs_language_file']:'';
$cs_plugin_options['cs_vat_switch']=isset($cs_plugin_options['cs_vat_switch']) ? $cs_plugin_options['cs_vat_switch']:'';
$cs_plugin_options['cs_payment_vat']=isset($cs_plugin_options['cs_payment_vat']) ? $cs_plugin_options['cs_payment_vat']:'';
$cs_plugin_options['cs_currency_type']=isset($cs_plugin_options['cs_currency_type']) ? $cs_plugin_options['cs_currency_type']:'';
$cs_plugin_options['currency_sign']=isset($cs_plugin_options['currency_sign']) ? $cs_plugin_options['currency_sign']:'';
$cs_plugin_options['cs_paypal_gateway_logo']=isset($cs_plugin_options['cs_paypal_gateway_logo']) ? $cs_plugin_options['cs_paypal_gateway_logo']:'';
$cs_plugin_options['cs_paypal_gateway_status']=isset($cs_plugin_options['cs_paypal_gateway_status']) ? $cs_plugin_options['cs_paypal_gateway_status']:'';
$cs_plugin_options['cs_paypal_sandbox']=isset($cs_plugin_options['cs_paypal_sandbox']) ? $cs_plugin_options['cs_paypal_sandbox']:'';
$cs_plugin_options['paypal_email']=isset($cs_plugin_options['paypal_email']) ? $cs_plugin_options['paypal_email']:'';
$cs_plugin_options['dir_paypal_ipn_url']=isset($cs_plugin_options['dir_paypal_ipn_url']) ? $cs_plugin_options['dir_paypal_ipn_url']:'';
$cs_plugin_options['cs_authorizedotnet_gateway_logo']=isset($cs_plugin_options['cs_authorizedotnet_gateway_logo']) ? $cs_plugin_options['cs_authorizedotnet_gateway_logo']:'';
$cs_plugin_options['cs_authorizedotnet_gateway_status']=isset($cs_plugin_options['cs_authorizedotnet_gateway_status']) ? $cs_plugin_options['cs_authorizedotnet_gateway_status']:'';
$cs_plugin_options['cs_authorizenet_sandbox']=isset($cs_plugin_options['cs_authorizenet_sandbox']) ? $cs_plugin_options['cs_authorizenet_sandbox']:'';
$cs_plugin_options['authorizenet_login']=isset($cs_plugin_options['authorizenet_login']) ? $cs_plugin_options['authorizenet_login']:'';
$cs_plugin_options['authorizenet_transaction_key']=isset($cs_plugin_options['authorizenet_transaction_key']) ? $cs_plugin_options['authorizenet_transaction_key']:'';
$cs_plugin_options['dir_authorizenet_ipn_url']=isset($cs_plugin_options['dir_authorizenet_ipn_url']) ? $cs_plugin_options['dir_authorizenet_ipn_url']:'';
$cs_plugin_options['cs_pre_bank_transfer_logo']=isset($cs_plugin_options['cs_pre_bank_transfer_logo']) ? $cs_plugin_options['cs_pre_bank_transfer_logo']:'';
$cs_plugin_options['cs_pre_bank_transfer_status']=isset($cs_plugin_options['cs_pre_bank_transfer_status']) ? $cs_plugin_options['cs_pre_bank_transfer_status']:'';
$cs_plugin_options['cs_bank_information']=isset($cs_plugin_options['cs_bank_information']) ? $cs_plugin_options['cs_bank_information']:'';
$cs_plugin_options['cs_bank_account_id']=isset($cs_plugin_options['cs_bank_account_id']) ? $cs_plugin_options['cs_bank_account_id']:'';
$cs_plugin_options['cs_other_information']=isset($cs_plugin_options['cs_other_information']) ? $cs_plugin_options['cs_other_information']:'';
$cs_plugin_options['cs_skrill_gateway_logo']=isset($cs_plugin_options['cs_skrill_gateway_logo']) ? $cs_plugin_options['cs_skrill_gateway_logo']:'';
$cs_plugin_options['cs_skrill_gateway_status']=isset($cs_plugin_options['cs_skrill_gateway_status']) ? $cs_plugin_options['cs_skrill_gateway_status']:'';
$cs_plugin_options['skrill_email']=isset($cs_plugin_options['skrill_email']) ? $cs_plugin_options['skrill_email']:'';
$cs_plugin_options['cs_skrill_ipn_url']=isset($cs_plugin_options['cs_skrill_ipn_url']) ? $cs_plugin_options['cs_skrill_ipn_url']:'';
$cs_plugin_options['cs_extras_switch']=isset($cs_plugin_options['cs_extras_switch']) ? $cs_plugin_options['cs_extras_switch']:'';
$cs_plugin_options['dynamic_booking_extra_feature']=isset($cs_plugin_options['dynamic_booking_extra_feature']) ? $cs_plugin_options['dynamic_booking_extra_feature']:'';
$cs_plugin_options['extra_feature_id_array']=isset($cs_plugin_options['extra_feature_id_array']) ? $cs_plugin_options['extra_feature_id_array']:'';
$cs_plugin_options['cs_extra_feature_title_array']=isset($cs_plugin_options['cs_extra_feature_title_array']) ? $cs_plugin_options['cs_extra_feature_title_array']:'';
$cs_plugin_options['cs_extra_feature_price_array']=isset($cs_plugin_options['cs_extra_feature_price_array']) ? $cs_plugin_options['cs_extra_feature_price_array']:'';
$cs_plugin_options['cs_extra_feature_type_array']=isset($cs_plugin_options['cs_extra_feature_type_array']) ? $cs_plugin_options['cs_extra_feature_type_array']:'';
$cs_plugin_options['cs_extra_feature_guests_array']=isset($cs_plugin_options['cs_extra_feature_guests_array']) ? $cs_plugin_options['cs_extra_feature_guests_array']:'';
$cs_plugin_options['cs_extra_feature_fchange_array']=isset($cs_plugin_options['cs_extra_feature_fchange_array']) ? $cs_plugin_options['cs_extra_feature_fchange_array']:'';
$cs_plugin_options['cs_extra_feature_fchange1452778298']=isset($cs_plugin_options['cs_extra_feature_fchange1452778298']) ? $cs_plugin_options['cs_extra_feature_fchange1452778298']:'';
$cs_plugin_options['cs_extra_feature_desc_array']=isset($cs_plugin_options['cs_extra_feature_desc_array']) ? $cs_plugin_options['cs_extra_feature_desc_array']:'';
$cs_plugin_options['cs_extra_feature_title']=isset($cs_plugin_options['cs_extra_feature_title']) ? $cs_plugin_options['cs_extra_feature_title']:'';
$cs_plugin_options['cs_extra_feature_price']=isset($cs_plugin_options['cs_extra_feature_price']) ? $cs_plugin_options['cs_extra_feature_price']:'';
$cs_plugin_options['cs_extra_feature_type']=isset($cs_plugin_options['cs_extra_feature_type']) ? $cs_plugin_options['cs_extra_feature_type']:'';
$cs_plugin_options['cs_extra_feature_guests']=isset($cs_plugin_options['cs_extra_feature_guests']) ? $cs_plugin_options['cs_extra_feature_guests']:'';
$cs_plugin_options['cs_extra_feature_fchange']=isset($cs_plugin_options['cs_extra_feature_fchange']) ? $cs_plugin_options['cs_extra_feature_fchange']:'';
$cs_plugin_options['cs_extra_feature_desc']=isset($cs_plugin_options['cs_extra_feature_desc']) ? $cs_plugin_options['cs_extra_feature_desc']:'';
$cs_plugin_options['cs_features_switch']=isset($cs_plugin_options['cs_features_switch']) ? $cs_plugin_options['cs_features_switch']:'';
$cs_plugin_options['dynamic_booking_feats']=isset($cs_plugin_options['dynamic_booking_feats']) ? $cs_plugin_options['dynamic_booking_feats']:'';
$cs_plugin_options['feats_id_array']=isset($cs_plugin_options['feats_id_array']) ? $cs_plugin_options['feats_id_array']:'';
$cs_plugin_options['cs_feats_title_array']=isset($cs_plugin_options['cs_feats_title_array']) ? $cs_plugin_options['cs_feats_title_array']:'';
$cs_plugin_options['cs_feats_image_array']=isset($cs_plugin_options['cs_feats_image_array']) ? $cs_plugin_options['cs_feats_image_array']:'';
$cs_plugin_options['cs_feats_desc_array']=isset($cs_plugin_options['cs_feats_desc_array']) ? $cs_plugin_options['cs_feats_desc_array']:'';
$cs_plugin_options['cs_feats_title']=isset($cs_plugin_options['cs_feats_title']) ? $cs_plugin_options['cs_feats_title']:'';
$cs_plugin_options['cs_feats_image24928339']=isset($cs_plugin_options['cs_feats_image24928339']) ? $cs_plugin_options['cs_feats_image24928339']:'';
$cs_plugin_options['cs_feats_desc']=isset($cs_plugin_options['cs_feats_desc']) ? $cs_plugin_options['cs_feats_desc']:'';
$cs_plugin_options['cs_reviews_per_page']=isset($cs_plugin_options['cs_reviews_per_page']) ? $cs_plugin_options['cs_reviews_per_page']:'';
$cs_plugin_options['cs_reviews_front']=isset($cs_plugin_options['cs_reviews_front']) ? $cs_plugin_options['cs_reviews_front']:'';
$cs_plugin_options['cs_review_status']=isset($cs_plugin_options['cs_review_status']) ? $cs_plugin_options['cs_review_status']:'';
$cs_plugin_options['cs_review_booking_id']=isset($cs_plugin_options['cs_review_booking_id']) ? $cs_plugin_options['cs_review_booking_id']:'';
$cs_plugin_options['dynamic_booking_dyn_reviews']=isset($cs_plugin_options['dynamic_booking_dyn_reviews']) ? $cs_plugin_options['dynamic_booking_dyn_reviews']:'';
$cs_plugin_options['dyn_reviews_id_array']=isset($cs_plugin_options['dyn_reviews_id_array']) ? $cs_plugin_options['dyn_reviews_id_array']:'';
$cs_plugin_options['cs_dyn_reviews_title_array']=isset($cs_plugin_options['cs_dyn_reviews_title_array']) ? $cs_plugin_options['cs_dyn_reviews_title_array']:'';
$cs_plugin_options['cs_dyn_reviews_title']=isset($cs_plugin_options['cs_dyn_reviews_title']) ? $cs_plugin_options['cs_dyn_reviews_title']:'';
$cs_plugin_options['cs_childs']=isset($cs_plugin_options['cs_childs']) ? $cs_plugin_options['cs_childs']:'';
$cs_plugin_options['cs_adults']=isset($cs_plugin_options['cs_adults']) ? $cs_plugin_options['cs_adults']:'';
$cs_plugin_options['action']=isset($cs_plugin_options['action']) ? $cs_plugin_options['action']:'';
$cs_plugin_options['cs_extra_features_options']=isset($cs_plugin_options['cs_extra_features_options']) ? $cs_plugin_options['cs_extra_features_options']:'';
$cs_plugin_options['cs_feats_options']=isset($cs_plugin_options['cs_feats_options']) ? $cs_plugin_options['cs_feats_options']:'';
$cs_plugin_options['cs_dyn_reviews_options']=isset($cs_plugin_options['cs_dyn_reviews_options']) ? $cs_plugin_options['cs_dyn_reviews_options']:'';
...
$cs_theme_options['cs_tag_line']=isset($cs_theme_options['cs_tag_line']) ? $cs_theme_options['cs_tag_line']:'';
$cs_theme_options['cs_post_ad_title']=isset($cs_theme_options['cs_post_ad_title']) ? $cs_theme_options['cs_post_ad_title']:'';
$cs_theme_options['cs_reservation_button_link']=isset($cs_theme_options['cs_reservation_button_link']) ? $cs_theme_options['cs_reservation_button_link']:'';
$cs_theme_options['cs_header_top_strip']=isset($cs_theme_options['cs_header_top_strip']) ? $cs_theme_options['cs_header_top_strip']:'';
$cs_theme_options['cs_music_setting_switch']=isset($cs_theme_options['cs_music_setting_switch']) ? $cs_theme_options['cs_music_setting_switch']:'';
$cs_theme_options['cs_music_url']=isset($cs_theme_options['cs_music_url']) ? $cs_theme_options['cs_music_url']:'';
$cs_theme_options['cs_get_locations']=isset($cs_theme_options['cs_get_locations']) ? $cs_theme_options['cs_get_locations']:'';
$cs_theme_options['cs_get_locations_url']=isset($cs_theme_options['cs_get_locations_url']) ? $cs_theme_options['cs_get_locations_url']:'';
...
$cs_theme_options['cs_weather_header_section']=isset($cs_theme_options['cs_weather_header_section']) ? $cs_theme_options['cs_weather_header_section']:'';
$cs_theme_options['cs_weather_text']=isset($cs_theme_options['cs_weather_text']) ? $cs_theme_options['cs_weather_text']:'';
$cs_theme_options['cs_weather_country']=isset($cs_theme_options['cs_weather_country']) ? $cs_theme_options['cs_weather_country']:'';
$cs_theme_options['cs_weather_city']=isset($cs_theme_options['cs_weather_city']) ? $cs_theme_options['cs_weather_city']:'';
$cs_theme_options['cs_cf_fc']=isset($cs_theme_options['cs_cf_fc']) ? $cs_theme_options['cs_cf_fc']:'';
...
$cs_theme_options['cs_heading_style']=isset($cs_theme_options['cs_heading_style']) ? $cs_theme_options['cs_heading_style']:'';
...
$cs_theme_options['cs_default_layout_sidebar']=isset($cs_theme_options['cs_default_layout_sidebar']) ? $cs_theme_options['cs_default_layout_sidebar']:'sidebar-1';
