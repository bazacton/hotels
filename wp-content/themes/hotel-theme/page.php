 ...
 */
get_header();
global $cs_node, $cs_sidebarLayout, $cs_xmlObject, $cs_node_id, $column_attributes, $cs_paged_id, $post;
...
if (isset($cs_xmlObject) && !empty($cs_xmlObject)) {
    if (isset($cs_page_layout)) {
    ...
    if (isset($cs_page_layout) && $cs_sidebarLayout <> '' and $cs_sidebarLayout <> "none") {
        ...
        if (isset($cs_page_layout) && $cs_sidebarLayout <> '' and $cs_sidebarLayout <> "none" and $cs_sidebarLayout == 'left') :
            ...
            <aside class="page-sidebar">
                <div class="col-md-12">
                    <?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar($cs_page_sidebar_left)) : endif; ?>
                </div>
            </aside>
        <?php
        endif;
    ...
    if (post_password_required()) {
        ...
        while (have_posts()) : the_post();
            if ((isset($image_url) && $image_url != '') || $post->post_content != '') {
                ...
                <a href="<?php echo esc_url($image_url); ?>" data-rel="prettyPhoto">
                    <figure>
                        <div class="page-featured-image">
                            <img class="img-thumbnail" alt="img" data-src="" style="width: 100%; "
    ...
    // @Show All Sections
    // ===================
    if (isset($cs_xmlObject->column_container) && $cs_xmlObject->column_container !== '') {
        $cs_elem_id = 0;
        foreach ($cs_xmlObject->column_container as $column_container) {
            ...
            if (isset($column_container)) {
                ...
                if (isset($cs_section_background_option) && $cs_section_background_option == 'section-custom-background-image') {
                    ...
                    if (function_exists('cs_glob_server')) {
                        $SERVER_NAME = cs_glob_server('SERVER_NAME');
                    }
            ...
            ?>
            <!-- Page Section -->
            <div <?php echo cs_allow_special_char($cs_section_css_id); ?>
                    class="page-section <?php echo sanitize_html_class($parallax_class); ?>" <?php echo cs_allow_special_char($parallax_data_type); ?>  <?php echo cs_allow_special_char($section_style_element); ?> >
                <?php
    ...
    if (isset($cs_page_layout) && $cs_sidebarLayout <> '' and $cs_sidebarLayout <> "none" and $cs_sidebarLayout == 'right') :
        ...
        <aside class="page-sidebar">
            <div class="col-md-12">
                <?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar($cs_page_sidebar_right)) : endif; ?>
            </div>
        </aside>
    <?php
    endif;
