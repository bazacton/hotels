    ...
    <div id="<?php echo esc_attr( $name.$cs_counter );?>_del" class="column  parentdelete <?php echo esc_attr( $coloumn_class );?> <?php echo esc_attr( $shortcode_view );?>" item="blog" data="<?php echo cs_element_size_data_array_index($blog_element_size)?>">
      ...
      <div class="cs-wrapp-class-<?php echo intval( $cs_counter )?> <?php echo esc_attr( $shortcode_element );?>" id="<?php echo esc_attr( $name.$cs_counter )?>" data-shortcode-template="[cs_blog {{attributes}}]"  style="display: none;">
        <div class="cs-heading-area">
              <h5><?php _e('Edit Blog Options', 'luxury-hotel') ?></h5>
              ...
              <div class="cs-wrapp-clone cs-shortcode-wrapp">
                <?php
                 if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){cs_shortcode_element_size();}?>
                    ...
                    <ul class="form-elements">
                      <li class="to-label">
                        <label><?php _e('Choose Category','luxury-hotel');?></label>
                      </li>
                      <li class="to-field">
                        <div class="input-sec">
                          <div class="select-style">
                            <select name="cs_blog_cat[]" class="dropdown">
                              <option value="0"><?php _e('-- Select Category --','luxury-hotel');?></option>
                              <?php cs_show_all_cats('', '', $cs_blog_cat, "category");?>
                            </select>
                          </div>
                        </div>
                        <div class="left-info">
                          <p><?php _e('Please select category to show posts. If you dont select category it will display all posts.','luxury-hotel');?></p>
                        </div>
                      </li>
                    </ul>
                        <ul class="form-elements">
                          <li class="to-label">
                            <label><?php _e('Blog Design Views','luxury-hotel');?></label>
                          </li>
                          <li class="to-field">
                            <div class="input-sec">
                              <div class="select-style">
                                <select name="cs_blog_view[]" class="dropdown">
                                  <option value="blog-medium" <?php if($cs_blog_view == 'blog-medium'){echo 'selected="selected"';}?>><?php _e('Blog Medium', 'luxury-hotel') ?></option>
                                  <option value="blog-small" <?php if($cs_blog_view == 'blog-small'){echo 'selected="selected"';}?>><?php _e('Blog Small', 'luxury-hotel') ?></option>
                                  <option value="blog-lrg" <?php if($cs_blog_view == 'blog-lrg'){echo 'selected="selected"';}?>><?php _e('Blog Large', 'luxury-hotel') ?></option>
                                  <option value="blog-mesnory" <?php if($cs_blog_view == 'blog-mesnory'){echo 'selected="selected"';}?>><?php _e('Blog Masonry', 'luxury-hotel') ?></option>
                                  <option value="blog-grid" <?php if($cs_blog_view == 'blog-grid'){echo 'selected="selected"';}?>><?php _e('Blog Grid', 'luxury-hotel') ?></option>
                                  <option value="blog-grid-plain" <?php if($cs_blog_view == 'blog-grid-plain'){echo 'selected="selected"';}?>><?php _e('Blog Grid Plain', 'luxury-hotel') ?></option>
                                </select>
                              </div>
                            </div>
                            <div class="left-info">
                              <p><?php _e('Please select blog view.','luxury-hotel');?></p>
                            </div>
                          </li>
                        </ul>
                      ...
                      <ul class="form-elements">
                        <li class="to-label">
                          <label><?php _e('Post Order','luxury-hotel');?></label>
                        </li>
                        <li class="to-field">
                          <div class="input-sec">
                            <div class="select-style">
                              <select name="cs_blog_orderby[]" class="dropdown" >
                                <option <?php if($cs_blog_orderby=="ASC")echo "selected";?> value="ASC"><?php _e('Asc','luxury-hotel');?></option>
                                <option <?php if($cs_blog_orderby=="DESC")echo "selected";?> value="DESC"><?php _e('DESC','luxury-hotel');?></option>
                              </select>
                            </div>
                          </div>
                        </li>
                      ...
                      <ul class="form-elements">
                        <li class="to-label">
                          <label><?php _e('Post Description','luxury-hotel');?></label>
                        </li>
                        <li class="to-field">
                          <div class="input-sec">
                            <div class="select-style">
                              <select name="cs_blog_description[]" class="dropdown" >
                                <option <?php if($cs_blog_description=="yes")echo "selected";?> value="yes"><?php _e('Yes','luxury-hotel');?></option>
                                <option <?php if($cs_blog_description=="no")echo "selected";?> value="no"><?php _e('No','luxury-hotel');?></option>
                              </select>
                            </div>
                          </div>
                        </li>
                      ...
                      <ul class="form-elements">
                        <li class="to-label">
                          <label><?php _e('Length of Excerpt','luxury-hotel');?></label>
                        </li>
                        <li class="to-field">
                          <div class="input-sec">
                          ...
                          <div class="left-info">
                            <p><?php _e('Enter number of character for short description text.','luxury-hotel');?></p>
                          </div>
                        </li>
                      </ul>
                </div>
                    <ul class="form-elements">
                      <li class="to-label">
                        <label><?php _e('No. of Post Per Page','luxury-hotel');?></label>
                      </li>
                      <li class="to-field">
                        <div class="input-sec">
                        ...
                        <div class="left-info">
                          <p><?php _e('To display all the records, leave this field blank.','luxury-hotel');?></p>
                        </div>
                      </li>
                    </ul>
                    <ul class="form-elements">
                      <li class="to-label">
                        <label><?php _e('Pagination','luxury-hotel');?></label>
                      </li>
                      <li class="to-field select-style">
                        <select name="blog_pagination[]" class="dropdown">
                          <option <?php if($blog_pagination=="Show Pagination")echo "selected";?> ><?php _e('Show Pagination','luxury-hotel');?></option>
                          <option <?php if($blog_pagination=="Single Page")echo "selected";?> ><?php _e('Single Page','luxury-hotel');?></option>
                        </select>
                      </li>
                    </ul>
