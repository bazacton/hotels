...
if (!function_exists('cs_accordion_shortcode')) {
    ...
    function cs_accordion_shortcode($atts, $content = "") {
        ...
        if (isset($cs_accordian_section_title) && trim($cs_accordian_section_title) <> '') {
            if (function_exists('cs_section')) {
                $section_title = cs_section('cs-section-title', $cs_accordian_section_title, '2');
            }
        }
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add(CS_SC_ACCORDION, 'cs_accordion_shortcode');
    }
}
...
if (!function_exists('cs_accordion_item_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add(CS_SC_ACCORDIONITEM, 'cs_accordion_item_shortcode');
    }
}
?>