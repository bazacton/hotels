...
if (!function_exists('cs_table_shortcode_func')) {
    function cs_table_shortcode_func($atts, $content = "") {
        ...
        return '<div class="cs-pricing-table table-responsive ' . $table_style . ' ' . sanitize_html_class($column_class).' '. sanitize_html_class($cs_table_class).'">'.$section_title.do_shortcode($content).'</div>';
    }
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add(CS_SC_TABLES, 'cs_table_shortcode_func');
...
if (!function_exists('cs_table_shortcode')) {
    function cs_table_shortcode($atts, $content = "") {
        ...
        return $table_data . '<table class="table '.sanitize_html_class($class).'">'.do_shortcode($content).'</table>';
    }
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add(CS_SC_TABLE, 'cs_table_shortcode');
...
if (!function_exists('cs_table_body_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add(CS_SC_TABLEBODY, 'cs_table_body_shortcode');
...
if (!function_exists('cs_table_head_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add(CS_SC_TABLEHEAD, 'cs_table_head_shortcode');
...
if (!function_exists('cs_table_row_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add(CS_SC_TABLEROW, 'cs_table_row_shortcode');
...
if (!function_exists('cs_table_heading_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add(CS_SC_TABLEHEADING, 'cs_table_heading_shortcode');
...
if (!function_exists('cs_table_data_shortcode')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add(CS_SC_TABLECOLUMN, 'cs_table_data_shortcode');
