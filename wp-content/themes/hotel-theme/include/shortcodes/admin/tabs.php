...
<div id="<?php echo cs_allow_special_char($name.$cs_counter)?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class);?> <?php echo cs_allow_special_char($shortcode_view);?>" item="gallery" data="<?php echo cs_element_size_data_array_index($tabs_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo cs_allow_special_char($cs_counter)?> <?php echo cs_allow_special_char($shortcode_element);?>" id="<?php echo cs_allow_special_char($name.$cs_counter)?>" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Tabs Options','luxury-hotel');?></h5>
      ...
      <div class="cs-wrapp-tab-box">
        <div id="shortcode-item-<?php echo cs_allow_special_char($cs_counter);?>" data-shortcode-template="{{child_shortcode}} [/<?php echo CS_SC_TABS;?>]" data-shortcode-child-template="[<?php echo CS_SC_TABSITEM;?> {{attributes}}] {{content}} [/<?php echo CS_SC_TABSITEM;?>]">
          <div class="cs-wrapp-clone cs-shortcode-wrapp cs-disable-true cs-pbwp-content" data-template="[<?php echo CS_SC_TABS;?> {{attributes}}]">
            ...
            <ul class="form-elements">
              <li class="to-label">
                <label><?php _e('Tab Style','luxury-hotel');?></label>
              </li>
              <li class="to-field">
                <div class="select-style">
                  <select name="cs_tab_style[]">
                    <option <?php if($cs_tab_style=="default")echo "selected";?> value="default" ><?php _e('Default','luxury-hotel');?></option>
                           <option <?php if($cs_tab_style=="vertical")echo "selected";?> value="vertical" ><?php _e('Vertical','luxury-hotel');?></option>
                  </select>
                </div>
              </li>
            </ul>
          ...
          <div class='cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content'  id="cs_infobox_<?php echo cs_allow_special_char($rand_id);?>">
            ...
            <ul class='form-elements'>
              <li class='to-label'>
                <label><?php _e('Active','luxury-hotel');?></label>
              </li>
              <li class='to-field'>
                <div class="select-style">
                  <select name='tab_active[]'>
                    <option <?php if(isset($tab_active) and $tab_active == 'no') echo 'selected'; ?> value="no"><?php _e('No','luxury-hotel');?></option>
                    <option <?php if(isset($tab_active) and $tab_active == 'yes') echo 'selected'; ?> value="yes"><?php _e('Yes','luxury-hotel');?></option>
                  </select>
                  <div class='left-info'>
            ...
            <ul class='form-elements'>
              <li class='to-label'>
                <label><?php _e('Tab Title','luxury-hotel');?></label>
              </li>
              <li class='to-field'>
                <div class='input-sec'>
            ...
            <ul class='form-elements' id="cs_infobox_<?php echo cs_allow_special_char($name.$rand_id);?>">
              <li class='to-label'>
                <label><?php _e('Tab Fontawsome Icon','luxury-hotel');?></label>
              </li>
              <li class="to-field">
                <?php cs_fontawsome_icons_box($cs_tab_icon,$rand_id,'cs_tab_icon');?>
                <div class='left-info'>
                  <p><?php _e('select the fontawsome Icons you would like to add to your menu items','luxury-hotel');?> </p>
                </div>
              </li>
            </ul>
            <ul class='form-elements'>
              <li class='to-label'>
                <label><?php _e('Tab Text','luxury-hotel');?></label>
              </li>
              <li class='to-field'>
                <div class='input-sec'>
        ...
        <div class="wrapptabbox">
          <div class="opt-conts">
            <ul class="form-elements noborder">
              <li class="to-field"> <a href="#" class="add_servicesss cs-main-btn" onclick="cs_shortcode_element_ajax_call('tabs', 'shortcode-item-<?php echo cs_allow_special_char($cs_counter);?>', '<?php echo cs_allow_special_char(admin_url('admin-ajax.php'));?>')"><i class="icon-plus-circle"></i><?php _e('Add Tab','luxury-hotel');?></a> </li>
               <div id="loading" class="shortcodeload"></div>
            </ul>
            <?php if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){?>
            <ul class="form-elements insert-bg">
              <li class="to-field"> <a class="insert-btn cs-main-btn" onclick="javascript:Shortcode_tab_insert_editor('<?php echo esc_js(str_replace('cs_pb_','',$name));?>','shortcode-item-<?php echo cs_allow_special_char($cs_counter);?>','<?php echo cs_allow_special_char($filter_element);?>')" ><?php _e('Insert','luxury-hotel');?></a> </li>
            </ul>
