...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="promobox" data="<?php echo cs_element_size_data_array_index($promobox_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" data-shortcode-template="[<?php echo esc_attr( CS_SC_PROMOBOX ) ;?> {{attributes}}]{{content}}[/<?php echo esc_attr( CS_SC_PROMOBOX ) ;?>]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Promo Box Options','luxury-hotel');?></h5>
      ...
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field">
            ...
            <input name="cs_promo_image_url<?php echo esc_attr($cs_counter)?>" type="button" class="uploadMedia left" value="<?php _e('Browse','luxury-hotel');?>"/>
            <div class="left-info">
            
            <p><?php _e('Promo Box Background image here','luxury-hotel');?></p>
            </div>
          </li>
        </ul>
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Background Repeat','luxury-hotel');?></label>
          </li>
          <li class="to-field select-style">
            <select class="bg_repeat" name="bg_repeat[]">
              <option <?php if($bg_repeat == 'yes'){echo 'selected="selected"';}?> value="yes"><?php _e('Yes','luxury-hotel');?></option>
              <option <?php if($bg_repeat == 'no'){echo 'selected="selected"';}?> value="no"><?php _e('No','luxury-hotel');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Text Align','luxury-hotel');?></label>
          </li>
          <li class="to-field select-style">
            <select class="text_align" name="text_align[]">
              <option <?php if($text_align == 'left'){echo 'selected="selected"';}?> value="left"><?php _e('Left','luxury-hotel');?></option>
              <option <?php if($text_align == 'right'){echo 'selected="selected"';}?> value="right"><?php _e('Right','luxury-hotel');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field">
            ...
            <p><?php _e('Give External/Internal Promo Box url','luxury-hotel');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
