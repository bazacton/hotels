  ...
  <?php cs_element_setting($name,$cs_counter,$heading_element_size, '', 'h-square',$type='');?>
	  <div class="cs-wrapp-class-<?php echo intval($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>"  data-shortcode-template="[<?php echo esc_attr( CS_SC_HEADING );?> {{attributes}}]{{content}}[/<?php echo esc_attr( CS_SC_HEADING );?>]" style="display: none;">
		<div class="cs-heading-area">
			<h5><?php _e('Edit Heading Options','luxury-hotel');?></h5>
		  ...
		  <div class="cs-wrapp-clone cs-shortcode-wrapp">
			<?php if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){cs_shortcode_element_size();}?>
				<ul class="form-elements">
				 	...
				 	<!--<ul class="form-elements">
					  <li class="to-label">
						<label><?php //_e('Color Title','luxury-hotel');?></label>
					  </li>
					  <li class="to-field">
				...
				<ul class="form-elements">
					  ...
					  <li class="to-field">
						...
						<p><?php _e('Enter content here','luxury-hotel');?></p>
					  </li>
				</ul>
				<ul class="form-elements">
				  <li class="to-label">
				  ...
				  <li class="to-field select-style">
					<select name="heading_style[]">
					  ...
					  <option <?php if($heading_style=="fancy")echo "selected";?> value="fancy" ><?php _e('Fancy','luxury-hotel');?></option>
				...
				<ul class="form-elements">
					  <li class="to-label">
						<label><?php _e('Font Size','luxury-hotel');?></label>
					  </li>
					  <li class="to-field">
						...
						<p><?php _e('add font size number for the heading','luxury-hotel');?></p>
					  </li>
				</ul>
				<ul class="form-elements">
					  <li class="to-label">
					  ...
					  <li class="to-field select-style">
						<select class="dropdown" name="heading_align[]">
						  <option value="left" <?php if($heading_align=='left'){echo 'selected="selected"';}?>><?php _e('Left','luxury-hotel');?></option>
						  <option  value="center" <?php if($heading_align=='center'){echo 'selected="selected"';}?>><?php _e('Center','luxury-hotel');?></option>
						  <option value="right" <?php if($heading_align=='right'){echo 'selected="selected"';}?>><?php _e('Right','luxury-hotel');?></option>
						</select>
				...
				<ul class="form-elements">
					  <li class="to-label">
						<label><?php _e('Divider On/Off','luxury-hotel');?></label>
					  </li>
					  <li class="to-field select-style">
						<select class="dropdown" name="heading_divider[]">
						  <option value="on" <?php if($heading_divider=='on'){echo 'selected="selected"';}?>><?php _e('On','luxury-hotel');?></option>
						  <option  value="off" <?php if($heading_divider=='off'){echo 'selected="selected"';}?>><?php _e('Off','luxury-hotel');?></option>
						</select>
						<p><?php _e('set divider on/off for the list bottom border','luxury-hotel');?></p>
					  </li>
				</ul>
				<ul class="form-elements">
					  <li class="to-label">
						<label><?php _e('Font Style','luxury-hotel');?></label>
					  </li>
					  <li class="to-field select-style">
						<select class="dropdown" name="heading_font_style[]">
						  <option value="normal" <?php if($heading_font_style=='normal'){echo 'selected="selected"';}?>><?php _e('Normal','luxury-hotel');?></option>
						  <option value="italic" <?php if($heading_font_style=='italic'){echo 'selected="selected"';}?>><?php _e('Italic','luxury-hotel');?></option>
						  <option value="oblique" <?php if($heading_font_style=='oblique'){echo 'selected="selected"';}?>><?php _e('Oblique','luxury-hotel');?></option>
						</select>
						<p><?php _e('select a font style from the drop down','luxury-hotel');?></p>
					  </li>
				</ul>
				<ul class="form-elements">
					  <li class="to-label">
						<label><?php _e('Heading Color','luxury-hotel');?></label>
					  </li>
					  <li class="to-field">
						<input type="text" name="heading_color[]" class="bg_color"  value="<?php echo esc_attr($heading_color);?>" />
						<div class="left-info">
						  <p><?php _e('heading color for the heading element','luxury-hotel');?></p>
						</div>
					  </li>
				</ul>
				<ul class="form-elements">
					  ...
					  <li class="to-field">
						...
						<div class="left-info">
						  <p><?php _e('set a content color for the heading element','luxury-hotel');?></p>
						</div>
					  </li>
				</ul>
