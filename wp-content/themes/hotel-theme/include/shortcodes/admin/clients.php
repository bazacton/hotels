...
<div id="<?php echo cs_allow_special_char($name.$cs_counter);?>_del" class="column  parentdelete <?php echo cs_allow_special_char($coloumn_class);?> <?php echo cs_allow_special_char($shortcode_view);?>" item="column" data="<?php echo cs_element_size_data_array_index($clients_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo cs_allow_special_char($cs_counter)?> <?php echo cs_allow_special_char($shortcode_element);?>" id="<?php echo cs_allow_special_char($name.$cs_counter);?>" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Clients Options','luxury-hotel');?></h5>
      ...
      <div class="cs-wrapp-tab-box">
        <div id="shortcode-item-<?php echo esc_attr($cs_counter);?>" data-shortcode-template="{{child_shortcode}} [/<?php echo esc_attr( CS_SC_CLIENTS ) ;?>]" data-shortcode-child-template="[<?php echo esc_attr( CS_SC_CLIENTSITEM ) ;?> {{attributes}}] {{content}} [/<?php echo esc_attr( CS_SC_CLIENTSITEM ) ;?>]">
          <div class="cs-wrapp-clone cs-shortcode-wrapp cs-disable-true" data-template="[<?php echo esc_attr( CS_SC_CLIENTS ) ;?> {{attributes}}]">
            ...
            <ul class="form-elements">
              <li class="to-label">
                <label><?php _e('Gray Scale','luxury-hotel');?></label>
              </li>
              <li class="to-field select-style">
                <select class="cs_client_gray" id="cs_client_gray" name="cs_client_gray[]">
                  <option value="yes" <?php if($cs_client_gray == 'yes'){echo 'selected="selected"';}?>><?php _e('Yes','luxury-hotel');?></option>
                  <option value="no" <?php if($cs_client_gray == 'no'){echo 'selected="selected"';}?>><?php _e('No','luxury-hotel');?></option>
                </select>
              </li>
            </ul>
            <ul class="form-elements">
              ...
              <li class="to-field select-style">
                <select class="cs_client_border" id="cs_client_border" name="cs_client_border[]">
                  <option value="yes" <?php if($cs_client_border == 'yes'){echo 'selected="selected"';}?>><?php _e('Yes','luxury-hotel');?></option>
                  <option value="no" <?php if($cs_client_border == 'no'){echo 'selected="selected"';}?>><?php _e('no','luxury-hotel');?></option>
                </select>
              </li>
            </ul>
            <ul class="form-elements">
              <li class="to-label">
                <label><?php _e('Heading Style','luxury-hotel');?></label>
              </li>
              <li class="to-field select-style">
                <select class="cs_client_head_style" id="cs_client_head_style" name="cs_client_head_style[]">
                  <option value="heading-style-1" <?php if($cs_client_head_style == 'heading-style-1'){echo 'selected="selected"';}?>><?php _e('Style 1','luxury-hotel');?></option>
                  <option value="heading-style-2" <?php if($cs_client_head_style == 'heading-style-2'){echo 'selected="selected"';}?>><?php _e('Style 2','luxury-hotel');?></option>
                </select>
              </li>
            </ul>
            <ul class="form-elements">
          ...
          <?php
                ...
                ?>
                      <div class='cs-wrapp-clone cs-shortcode-wrapp'  id="cs_infobox_<?php echo cs_allow_special_char($rand_id);?>">
                        <header>
                          <h4><i class='icon-arrows'></i><?php _e('Clients','luxury-hotel');?></h4>
                        ...
                        <ul class="form-elements">
                          <li class="to-label">
.                            <label><?php _e('Website Url','luxury-hotel');?></label>
                          </li>
                          <li class="to-field">
                            <div class="input-sec">
                        ...
                        <ul class="form-elements">
                          ...
                          <li class="to-field">
                            ...
                            <input name="cs_client_logo<?php echo cs_allow_special_char($itemCounter)?>"  type="button" class="uploadMedia left" value="<?php _e('Browse','luxury-hotel');?>"/>
                          </li>
                        </ul>
        ...
        <div class="wrapptabbox no-padding-lr">
          <div class="opt-conts">
            <ul class="form-elements noborder">
              <li class="to-field"> <a href="#" class="add_servicesss cs-main-btn" onclick="cs_shortcode_element_ajax_call('clients', 'shortcode-item-<?php echo cs_allow_special_char($cs_counter);?>', '<?php echo cs_allow_special_char(admin_url('admin-ajax.php'));?>')"><i class="icon-plus-circle"></i><?php _e('Add Client','luxury-hotel');?></a> </li>
