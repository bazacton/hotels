...
<div id="<?php echo esc_attr($name.$cs_counter);?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="blog" data="<?php echo cs_element_size_data_array_index($button_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" data-shortcode-template="[<?php echo esc_attr( CS_SC_BUTTON );?> {{attributes}}]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Button Options','luxury-hotel');?></h5>
      ...
      <div class="cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content">
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Size','luxury-hotel');?></label>
          </li>
          <li class="to-field select-style">
            <select class="button_size" id="button_size" name="button_size[]">
                <option value="btn-lg" <?php if($button_size == 'btn-lg'){echo 'selected="selected"';}?>><?php _e('Large','luxury-hotel');?> </option>
                <option  value="medium-btn" <?php if($button_size == 'medium-btn'){echo 'selected="selected"';}?>><?php _e('Medium','luxury-hotel');?></option>
                <option value="btn-sml" <?php if($button_size == 'btn-sml'){echo 'selected="selected"';}?>><?php _e('Small','luxury-hotel');?></option>
            </select>
            <div class='left-info'><p><?php _e('Select column width. This width will be calculated depend page width','luxury-hotel');?></p></div>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Button Title','luxury-hotel');?></label>
          </li>
          <li class="to-field">
        ...
        <ul class="form-elements">
          ...
          <li class="to-field">
            ...
            <div class='left-info'><p><?php _e('Button external/internal url','luxury-hotel');?></p></div>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
          ...
          <li class="to-field select-style">
            <select class="button_border" id="button_border" name="button_border[]">
              <option value="yes" <?php if($button_border == 'yes'){echo 'selected="selected"';}?>><?php _e('Yes','luxury-hotel');?> </option>
              <option  value="no" <?php if($button_border == 'no'){echo 'selected="selected"';}?>><?php _e('No','luxury-hotel');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Button Background Color','luxury-hotel');?></label>
          </li>
          <li class="to-field">
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Button Color','luxury-hotel');?></label>
          </li>
          <li class="to-field">
            <input type="text" name="button_color[]" class="bg_color" value="<?php echo esc_attr($button_color)?>" />
            <div class='left-info'><p><?php _e('select a color which you want on the buttons','luxury-hotel');?></p></div>
          </li>
        </ul>
        <ul class='form-elements' id="cs_infobox_<?php echo esc_attr($name.$cs_counter);?>">
          <li class='to-label'>
            <label><?php _e('Fontawsome Icon','luxury-hotel');?></label>
          </li>
          <li class="to-field">
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Button Icon Position','luxury-hotel');?></label>
          </li>
          <li class="to-field select-style">
            <select class="button_icon_position" id="button_icon_position" name="button_icon_position[]">
              <option value="left" <?php if($button_icon_position == 'left'){echo 'selected="selected"';}?>><?php _e('Left','luxury-hotel');?></option>
              <option value="right" <?php if($button_icon_position == 'right'){echo 'selected="selected"';}?>><?php _e('Right','luxury-hotel');?></option>
            </select>
            <div class='left-info'><p><?php _e('set a position for the button','luxury-hotel');?></p></div>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Button Type','luxury-hotel');?></label>
          </li>
          <li class="to-field select-style">
            <select class="button_type" id="button_type" name="button_type[]">
              <option value="rectangle" <?php if($button_type == 'rectangle'){echo 'selected="selected"';}?>><?php _e('Square','luxury-hotel');?></option>
              <option value="rounded" <?php if($button_type == 'rounded'){echo 'selected="selected"';}?>><?php _e('Rounded','luxury-hotel');?></option>
 
            </select>
           <div class='left-info'> <p><?php _e('Select the display type for the button','luxury-hotel');?></p></div>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Target','luxury-hotel');?></label>
          </li>
          <li class="to-field select-style">
            <select class="button_target" id="button_target" name="button_target[]">
              <option value="_blank" <?php if($button_target == '_blank'){echo 'selected="selected"';}?>><?php _e('Blank','luxury-hotel');?></option>
              <option value="_self" <?php if($button_target == '_self'){echo 'selected="selected"';}?>><?php _e('Self','luxury-hotel');?></option>
            </select>
          </li>
        </ul>
