...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="blog" data="<?php echo cs_element_size_data_array_index($map_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter);?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" data-shortcode-template="[<?php echo esc_attr( CS_SC_MAP );?> {{attributes}}]" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Map Options','luxury-hotel');?></h5>
    ...
    <div class="cs-pbwp-content">
      <div class="cs-wrapp-clone cs-shortcode-wrapp">
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Map Height','luxury-hotel');?></label>
          </li>
          <li class="to-field">
            <input type="text" name="map_height[]" class="txtfield" value="<?php echo esc_attr($map_height)?>" />
            <p><?php _e('Map height set here','luxury-hotel');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Latitude','luxury-hotel');?></label>
          </li>
          <li class="to-field">
            <input type="text" name="map_lat[]" class="txtfield" value="<?php echo esc_attr($map_lat)?>" />
            <p><?php _e('The map will appear only if this field is filled correctly','luxury-hotel');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Longitude','luxury-hotel');?></label>
          </li>
          <li class="to-field">
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Zoom','luxury-hotel');?></label>
          </li>
          <li class="to-field">
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Map Types','luxury-hotel');?></label>
          </li>
          <li class="to-field select-style">
            <select name="map_type[]" class="dropdown" >
               <option value="ROADMAP" <?php if($map_type=="ROADMAP")echo "selected";?> ><?php _e('ROADMAP','luxury-hotel');?></option>
              <option value="HYBRID" <?php if($map_type=="HYBRID")echo "selected";?> ><?php _e('HYBRID','luxury-hotel');?></option>
              <option value="SATELLITE" <?php if($map_type=="SATELLITE")echo "selected";?> ><?php _e('SATELLITE','luxury-hotel');?></option>
              <option value="TERRAIN" <?php if($map_type=="TERRAIN")echo "selected";?> ><?php _e('TERRAIN','luxury-hotel');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Info Text','luxury-hotel');?></label>
          </li>
          <li class="to-field">
            <input type="text" name="map_info[]" class="txtfield" value="<?php echo esc_attr($map_info)?>" />
            <p><?php _e('Enter the marker content','luxury-hotel');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Info Max Width','luxury-hotel');?></label>
          </li>
          <li class="to-field">
            <input type="text" name="map_info_width[]" class="txtfield" value="<?php echo esc_attr($map_info_width)?>" />
            <p><?php _e('set max width for the google map','luxury-hotel');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Info Max Height','luxury-hotel');?></label>
          </li>
          <li class="to-field">
            <input type="text" name="map_info_height[]" class="txtfield" value="<?php echo esc_attr($map_info_height)?>" />
            <p><?php _e('set max height for the google map','luxury-hotel');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Marker Icon Path','luxury-hotel');?></label>
          </li>
          <li class="to-field">
            ...
            <label class="browse-icon"><input name="map_marker_icon<?php echo esc_attr($rand_string)?>"  type="button" class="uploadMedia left" value="<?php _e('Browse','luxury-hotel');?>"/></label>
            <div class="left-info"><p><?php _e('Give a link for your marker icon','luxury-hotel');?></p></div>
          </li>
        </ul>
        ...
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Show Marker','luxury-hotel');?></label>
          </li>
          <li class="to-field select-style">
            <select name="map_show_marker[]" class="dropdown" >
              <option value="true" <?php if($map_show_marker=="true")echo "selected";?> ><?php _e('On','luxury-hotel');?></option>
              <option value="false" <?php if($map_show_marker=="false")echo "selected";?> ><?php _e('Off','luxury-hotel');?></option>
            </select>
            <p><?php _e('Set marker on/off for the map','luxury-hotel');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Disable Map Controls','luxury-hotel');?></label>
          </li>
          <li class="to-field select-style">
            <select name="map_controls[]" class="dropdown" >
              <option value="false" <?php if($map_controls=="false")echo "selected";?> ><?php _e('Off','luxury-hotel');?></option>
              <option value="true" <?php if($map_controls=="true")echo "selected";?> ><?php _e('On','luxury-hotel');?></option>
            </select>
            <p><?php _e('You can set map control disable/enable','luxury-hotel');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Dragable','luxury-hotel');?></label>
          </li>
          <li class="to-field select-style">
            <select name="map_draggable[]" class="dropdown" >
              <option value="true" <?php if($map_draggable=="true")echo "selected";?> ><?php _e('On','luxury-hotel');?></option>
              <option value="false" <?php if($map_draggable=="false")echo "selected";?> ><?php _e('Off','luxury-hotel');?></option>
            </select>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Scroll Wheel','luxury-hotel');?></label>
          </li>
          <li class="to-field select-style">
            <select name="map_scrollwheel[]" class="dropdown" >
              <option value="true" <?php if($map_scrollwheel=="true")echo "selected";?> ><?php _e('On','luxury-hotel');?></option>
              <option value="false" <?php if($map_scrollwheel=="false")echo "selected";?> ><?php _e('Off','luxury-hotel');?></option>
            </select>
            <p><?php _e('Set scroll wheel','luxury-hotel');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
            <label><?php _e('Border','luxury-hotel');?></label>
          </li>
          <li class="to-field select-style">
            <select class="dropdown" name="map_border[]">
              <option <?php if($map_border == 'yes'){echo 'selected="selected"';}?> value="yes"><?php _e('Yes','luxury-hotel');?></option>
              <option <?php if($map_border == 'no'){echo 'selected="selected"';}?> value="no"><?php _e('No','luxury-hotel');?></option>
            </select>
            <p><?php _e('Set border for map','luxury-hotel');?></p>
          </li>
        </ul>
        <ul class="form-elements">
          <li class="to-label">
          ...
          <li class="to-field">
            ...
            <div class="left-info">
            <p><?php _e('If you will select a border than select the border color','luxury-hotel');?></p>
            </div>
          </li>
        </ul>
