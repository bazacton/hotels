...
<div id="<?php echo esc_attr($name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="pricetable" data="<?php echo cs_element_size_data_array_index($pricetable_element_size)?>" >
  ...
  <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter)?>" style="display: none;">
    <div class="cs-heading-area">
      <h5><?php _e('Edit Price Table Options','luxury-hotel');?></h5>
            ...
            <div class="cs-wrapp-clone cs-shortcode-wrapp cs-disable-true" data-template="[<?php echo esc_attr( CS_SC_PRICETABLE );?> {{attributes}}]">
                  ...
                  <li class="to-field">
                    <div class="select-style">
                      <select name="pricetable_style[]" class="dropdown" onchange="cs_pricetable_style_vlaue(this.value, <?php echo esc_js($cs_counter);?>)" >
                        <option <?php if($pricetable_style=="classic")echo "selected";?> value="classic" ><?php _e('Classic','luxury-hotel');?></option>
                        <option <?php if($pricetable_style=="simple")echo "selected";?> value="simple" ><?php _e('Simple','luxury-hotel');?></option>
           
                      </select>
                      <div class='left-info'>
                        <div class='left-info'><p><?php _e('Choose a pricetable view','luxury-hotel');?></p></div>
                      </div>
                    </div>
                  </li>
                </ul>
                <ul class="form-elements">
                  ...
                  <li class="to-field">
                    ...
                    <div class='left-info'>
                      <div class='left-info'><p> <?php _e('set title for the item','luxury-hotel');?></p></div>
                    </div>
                  </li>
                </ul>
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Title Bg Color','luxury-hotel');?></label>
                  </li>
                  <li class="to-field">
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Price','luxury-hotel');?></label>
                  </li>
                  <li class="to-field">
                    <input type="text" name="pricetable_price[]" class="" value="<?php echo esc_attr($pricetable_price);?>" />
                    <div class='left-info'>
                      <div class='left-info'><p><?php _e('item Price','luxury-hotel');?></p></div>
                    </div>
                  </li>
                </ul>
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Currency Symbols','luxury-hotel');?></label>
                  </li>
                  <li class="to-field">
                    <input type="text" name="currency_symbols[]" class="" value="<?php echo esc_attr($currency_symbols);?>" />
                    <div class='left-info'>
                      <div class='left-info'><p><?php _e('item currency symbols','luxury-hotel');?></p></div>
                    </div>
                  </li>
                </ul>
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Time Duration','luxury-hotel');?></label>
                  </li>
                  <li class="to-field">
                    <input type="text" name="pricetable_period[]" class="" value="<?php echo esc_attr($pricetable_period);?>" />
                    <div class='left-info'>
                      <div class='left-info'><p><?php _e('set a time duration','luxury-hotel');?></p></div>
                    </div>
                  </li>
                </ul>
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Featured','luxury-hotel');?></label>
                  </li>
                  <li class="to-field select-style">
                    <select name="pricetable_featured[]" class="dropdown" >
                      <option <?php if($pricetable_featured=="Yes")echo "selected";?> ><?php _e('Yes','luxury-hotel');?></option>
                      <option <?php if($pricetable_featured=="No")echo "selected";?> ><?php _e('No','luxury-hotel');?></option>
                    </select>
                  </li>
                </ul>
                <ul class="form-elements">
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Pricing Features','luxury-hotel');?></label>
                  </li>
                  <li class="to-field"> <a class="add_field_button" href="#"  onclick="javascript:cs_add_field('cs-shortcode-wrapp_<?php echo esc_js($name.$cs_counter);?>','cs_infobox')"><?php _e('Add New Feature input box','luxury-hotel');?> <i class="icon-plus-circle" style="color:red; font-size:18px"></i></a> 
                  
                    <div class='left-info'>
                      <div class='left-info'><p><?php _e('Set feature price of the product','luxury-hotel');?></p></div>
                    </div>
                    ...
                    <div class='cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content'  id="cs_infobox_<?php echo esc_attr($rand_id);?>">
                      <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        <div id="<?php echo 'priceTable_'.esc_attr($rand_id);?>">
                          <ul class="form-elements bcevent_title">
                            <li class="to-label">
                              <label><?php _e('Pricing Feature','luxury-hotel');?><?php echo esc_attr($itemCounter);?></label>
                            </li>
                            <li class="to-field">
                              <div class="input-sec">
         ...
         <div class="hidden-object">
          ...
          <div class="opt-conts">
            ...
            <ul class="form-elements insert-bg">
              <li class="to-field"> <a class="insert-btn cs-main-btn" onclick="javascript:Shortcode_tab_insert_editor('<?php echo esc_js(str_replace('cs_pb_','',$name));?>','shortcode-item-<?php echo esc_js($cs_counter);?>','<?php echo esc_js($filter_element);?>')" ><?php _e('Insert','luxury-hotel');?></a> </li>
            </ul>
