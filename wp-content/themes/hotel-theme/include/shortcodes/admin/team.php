...
<div id="<?php echo esc_attr( $name.$cs_counter)?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class);?> <?php echo esc_attr($shortcode_view);?>" item="blog" data="<?php echo element_size_data_array_index($teams_element_size)?>">
      ...
      <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter)?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter);?>" data-shortcode-template="[<?php echo esc_attr( CS_SC_TEAM ) ;?> {{attributes}}]{{content}}[/<?php echo esc_attr( CS_SC_TEAM ) ;?>]"  style="display: none;">
        <div class="cs-heading-area">
          <h5><?php _e('Edit Team Options','luxury-hotel');?></h5>
        ...
        <div class="cs-pbwp-content">
          <div class="cs-wrapp-clone cs-shortcode-wrapp">
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Name','luxury-hotel');?></label>
                  </li>
                  <li class="to-field">
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Designation','luxury-hotel');?></label>
                  </li>
                  <li class="to-field">
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Team Profile Image','luxury-hotel');?></label>
                  </li>
                  <li class="to-field">
                    ...
                    <input name="cs_team_profile_image<?php echo esc_attr($rand_counter);?>"  type="button" class="uploadMedia left" value="<?php _e('Browse','luxury-hotel');?>"/>
                  </li>
                </ul>
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Facebook','luxury-hotel');?></label>
                  </li>
                  <li class="to-field">
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Twitter Url','luxury-hotel');?></label>
                  </li>
                  <li class="to-field">
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Google plus','luxury-hotel');?></label>
                  </li>
                  <li class="to-field">
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Skype','luxury-hotel');?></label>
                  </li>
                  <li class="to-field">
                ...
                <ul class="form-elements">
                  <li class="to-label">
                    <label><?php _e('Email','luxury-hotel');?></label>
                  </li>
                  <li class="to-field">
