...
if (!function_exists('cs_banner_ads_shortcode')) {
        ...
        if (isset($cs_theme_options['banner_field_code_no']) && is_array($cs_theme_options['banner_field_code_no'])) {
            ...
            if ($cs_banner_type == 'image') {
                if (!isset($_COOKIE["cs_banner_clicks_" . $cs_banner_code_no])) {
                    $html .= '<a onclick="cs_banner_click_count_plus(\'' . admin_url('admin-ajax.php') . '\', \'' . $cs_banner_code_no . '\')" id="cs_banner_clicks' . $cs_banner_code_no . '" href="' . $cs_banner_url . '" target="_blank"><img src="' . $cs_banner_image . '" alt="' . $cs_banner_title . '" /></a>';
                } else {
                    $html .= '<a href="' . $cs_banner_url . '" target="' . $cs_banner_url_target . '"><img src="' . $cs_banner_image . '" alt="' . $cs_banner_title . '" /></a>';
                }
            } else {
                $html .= wp_specialchars_decode(stripslashes($cs_banner_adsense_code));
            }
            $html .= '</div>';
        }
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_ads', 'cs_banner_ads_shortcode');
    }
}
...
if (!function_exists('cs_tags_render')) {
    ...
    function cs_tags_render($atts, $content = "") {
        ...
        if (isset($cs_xmlObject->cs_post_tags_show) && $cs_xmlObject->cs_post_tags_show == 'on') {
            ...
            if ($get_posts) {
                ...
                if ($tags_listtt) {
                    printf(__('%1$s', 'luxury-hotel'), $tags_listtt);
                }
            }
        }
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_tag', 'cs_tags_render');
    }
}
//=====================================================================
...
if (!function_exists('cs_content_render')) {
    ...
    function cs_content_render($atts, $content = "") {
        ...
        ob_start();
        the_content();
        wp_link_pages(array('before' => '<div class="page-links"><span class="page-links-title">' . __('Pages:', 'luxury-hotel') . '</span>', 'after' => '</div>', 'link_before' => '<span>', 'link_after' => '</span>'));
        $content_data = ob_get_clean();
        return $content_data;
    }
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_content', 'cs_content_render');
    }
...
if (!function_exists('cs_post_attachment_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_post_attachment', 'cs_post_attachment_render');
    }
}
//=====================================================================
...
if (!function_exists('cs_post_author_render')) {
        ...
        if (isset($cs_xmlObject->cs_post_author_info_show) && $cs_xmlObject->cs_post_author_info_show == 'on') {
            ...
            <div class="cs-content-wrap">
                <header class="cs-heading-title">
                    <h2 class=" cs-section-title"><?php _e('About', 'luxury-hotel'); ?> <?php _e('Author', 'luxury-hotel'); ?></h2>
                </header>
            ...
            <?php if (isset($social) && $social == 'on') { ?>
                ...
                <?php } ?>
                                <li class="share"><a href="#"><?php _e('View All Posts', 'luxury-hotel'); ?></a></li>
                            </ul>
            <?php } ?>
                    </div>
                </div>
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_author_description', 'cs_post_author_render');
        cs_shortcode_add('cs_author_detail', 'cs_post_author_render');
    }
}
//=====================================================================
// Links Render
...
if (!function_exists('cs_edit_link_render')) {
    ...
    function cs_edit_link_render($atts, $content = "") {
        global $post;
        ob_start();
        edit_post_link(__('Edit', 'luxury-hotel'), '<li>', '</li>');
        $edit_post_data = ob_get_clean();
        return $edit_post_data;
    }
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_edit', 'cs_edit_link_render');
    }
}
//=====================================================================
...
if (!function_exists('cs_next_previous_post_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_next_previous', 'cs_next_previous_post_render');
    }
}
//=====================================================================
// post share button
...
if (!function_exists('cs_share_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_share', 'cs_share_render');
    }
}
//=====================================================================
// Get related posts
...
if (!function_exists('cs_related_post_render')) {
                    ...
                    if ($custom_query->have_posts()):
                        while ($custom_query->have_posts()): $custom_query->the_post();
                            ...
                            <article <?php post_class($no_image); ?>>
                                <figure>
                    <?php if ($image_url <> "") { ?>
                                        <a href="<?php esc_url(the_permalink()); ?>"><img src="<?php echo esc_url($image_url); ?>" alt="img"></a>
                    <?php } ?>
                                </figure>
                                <!-- Text Section -->
                                <div class="text-sec">
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_related_post', 'cs_related_post_render');
    }
}
//=====================================================================
// Post comments
...
if (!function_exists('cs_comments_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_comments', 'cs_comments_render');
    }
}
//=====================================================================
// Post author
...
if (!function_exists('cs_author_render')) {
    ...
    function cs_author_render($atts, $content = "") {
        global $post;
        ob_start();
        printf(__('%s', 'luxury-hotel'), '<a href="' . get_author_posts_url(get_the_author_meta('ID')) . '" >' . get_the_author() . '</a>');
        $author_data = ob_get_clean();
        return $author_data;
    }
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_author', 'cs_author_render');
    }
}
//=====================================================================
// Post date
...
if (!function_exists('cs_postdate_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_postdate', 'cs_postdate_render');
    }
}
//=====================================================================
// Post Excerpt
...
if (!function_exists('cs_excerpt_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_excerpt', 'cs_excerpt_render');
    }
}
//=====================================================================
// Post Title
...
if (!function_exists('cs_title_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_title', 'cs_title_render');
    }
}
...
if (!function_exists('cs_featured_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_featured', 'cs_featured_render');
    }
}
//=====================================================================
// Rating
...
if (!function_exists('cs_rating_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_rating', 'cs_rating_render');
    }
}
//=====================================================================
// attachments
...
if (!function_exists('cs_mediaattachments_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_mediaattachments', 'cs_mediaattachments_render');
    }
}
//=====================================================================
// Model
...
if (!function_exists('cs_model_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_model', 'cs_model_render');
    }
}
//=====================================================================
// post sale milage
...
if (!function_exists('cs_milage_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_milage', 'cs_milage_render');
    }
}
//=====================================================================
// post price
...
if (!function_exists('cs_price_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_price', 'cs_price_render');
    }
}
//=====================================================================
// custom email
...
if (!function_exists('cs_custom_email_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_email', 'cs_custom_email_render');
    }
}
//=====================================================================
// custom text
...
if (!function_exists('cs_custom_text_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_text', 'cs_custom_text_render');
    }
}
//=====================================================================
// custom textarea 
...
if (!function_exists('cs_custom_textarea_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_textarea', 'cs_custom_text_render');
    }
}
//=====================================================================
// custom radio
...
if (!function_exists('cs_custom_radio_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_radio', 'cs_custom_radio_render');
    }
}
//=====================================================================
// post date
...
if (!function_exists('cs_date_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_date', 'cs_date_render');
    }
}
//=====================================================================
// multi select option
...
if (!function_exists('cs_multiselect_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_multiselect', 'cs_multiselect_render');
    }
}
//=====================================================================
// post url
...
if (!function_exists('cs_url_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_url', 'cs_url_render');
    }
}
//=====================================================================
...
if (!function_exists('cs_mediaattachment_count_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_mediaattachment_count', 'cs_mediaattachment_count_render');
    }
}
if (!function_exists('cs_map_location_link_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_map_location', 'cs_map_location_link_render');
    }
}
//=====================================================================
...
if (!function_exists('cs_location_address_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_location_address', 'cs_location_address_render');
    }
}
//=====================================================================
// post hidden
...
if (!function_exists('cs_hidden_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_hidden', 'cs_hidden_render');
    }
}
//=====================================================================
...
if (!function_exists('cs_post_dropdown_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_dropdown', 'cs_post_dropdown_render');
    }
}
//=====================================================================
// buy tickers
...
if (!function_exists('cs_buytickets_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_buytickets', 'cs_buytickets_render');
    }
}
//=====================================================================
// user wishlist
...
if (!function_exists('cs_wishlist_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_wishlist', 'cs_wishlist_render');
    }
}
//=====================================================================
// wishlist listing
...
if (!function_exists('cs_wishlist_listing_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_wishlisting', 'cs_wishlist_listing_render');
    }
}
//=====================================================================
// like counter
...
if (!function_exists('cs_likecounter_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_likecounter', 'cs_likecounter_render');
    }
}
//=====================================================================
// User Rating 
...
if (!function_exists('cs_user_rating_render')) {
    ...
    if(function_exists('cs_shortcode_add')){
        cs_shortcode_add('cs_user_rating', 'cs_user_rating_render');
    }
}
...
if (!function_exists('cs_shortcode_names')) {
    ...
    function cs_shortcode_names() {
        ...
        $shortcode_array = array(
            'blog' => array(
                'title' => __('Blog', 'luxury-hotel'),
                'name' => 'blog',
                'icon' => 'icon-newspaper',
                'categories' => 'loops',
            ),
            'button' => array(
                'title' => __('Button', 'luxury-hotel'),
                'name' => 'button',
                'icon' => 'icon-hand-o-up',
                'categories' => 'commonelements',
            ),
            'clients' => array(
                'title' => __('Clients', 'luxury-hotel'),
                'name' => 'clients',
                'icon' => 'icon-user3',
                'categories' => 'loops',
            ),
            'contactus' => array(
                'title' => __('Form', 'luxury-hotel'),
                'name' => 'contactus',
                'icon' => 'icon-building-o',
                'categories' => 'contentblocks',
            ),
            'counter' => array(
                'title' => __('Counter', 'luxury-hotel'),
                'name' => 'counter',
                'icon' => 'icon-clock-o',
                'categories' => 'commonelements',
            ),
            'divider' => array(
                'title' => __('Divider', 'luxury-hotel'),
                'name' => 'divider',
                'icon' => 'icon-ellipsis-h',
                'categories' => 'typography misc',
            ),
            'flex_column' => array(
                'title' => __('Column', 'luxury-hotel'),
                'name' => 'flex_column',
                'icon' => 'icon-columns',
                'categories' => 'typography misc',
            ),
            'call_to_action' => array(
                'title' => __('Call to Action', 'luxury-hotel'),
                'name' => 'call_to_action',
                'icon' => 'icon-info-circle',
                'categories' => 'commonelements',
            ),
            'heading' => array(
                'title' => __('Heading', 'luxury-hotel'),
                'name' => 'heading',
                'icon' => 'icon-h-square',
                'categories' => 'typography misc',
            ),
            'infobox' => array(
                'title' => __('Info box', 'luxury-hotel'),
                'name' => 'infobox',
                'icon' => 'icon-info-circle',
                'categories' => ' contentblocks',
            ),
            'image' => array(
                'title' => __('Image Frame', 'luxury-hotel'),
                'name' => 'image',
                'icon' => 'icon-photo2',
                'categories' => 'mediaelement',
            ),
            'list' => array(
                'title' => __('List', 'luxury-hotel'),
                'name' => 'list',
                'icon' => 'icon-list-ol',
                'categories' => 'typography misc    ',
            ),
            'map' => array(
                'title' => __('Map', 'luxury-hotel'),
                'name' => 'map',
                'icon' => 'icon-list-ol',
                'categories' => 'contentblocks',
            ),
            'multiple_services' => array(
                'title' => __('Multiple Services', 'luxury-hotel'),
                'name' => 'multiple_services',
                'icon' => 'icon-database2',
                'categories' => 'loops misc',
            ),
            'progressbars' => array(
                'title' => __('Progress Bars', 'luxury-hotel'),
                'name' => 'progressbars',
                'icon' => 'icon-list-alt',
                'categories' => ' commonelements',
            ),
            'promobox' => array(
                'title' => __('Promo box', 'luxury-hotel'),
                'name' => 'promobox',
                'icon' => 'icon-bullhorn',
                'categories' => ' mediaelement',
            ),
            'pricetable' => array(
                'title' => __('Price Table', 'luxury-hotel'),
                'name' => 'pricetable',
                'icon' => 'icon-table',
                'categories' => 'commonelements',
            ),
            'quote' => array(
                'title' => __('Quote', 'luxury-hotel'),
                'name' => 'quote',
                'icon' => 'icon-quote-right',
                'categories' => 'typography misc',
            ),
            'slider' => array(
                'title' => __('Slider', 'luxury-hotel'),
                'name' => 'slider',
                'icon' => 'icon-image2',
                'categories' => 'loops',
            ),
            'services' => array(
                'title' => __('Services', 'luxury-hotel'),
                'name' => 'services',
            ...
            'mailchimp' => array(
                'title' => __('Mail chimp', 'luxury-hotel'),
                'name' => 'mailchimp',
                'icon' => 'icon-envelope7',
                'categories' => 'commonelements',
            ),
            'tabs' => array(
                'title' => __('Tabs', 'luxury-hotel'),
                'name' => 'tabs',
                'icon' => 'icon-list-alt',
                'categories' => 'commonelements',
            ),
            'testimonials' => array(
                'title' => __('Testimonials', 'luxury-hotel'),
                'name' => 'testimonials',
                'icon' => 'icon-comments-o',
                'categories' => 'typography misc',
            ),
            'table' => array(
                'title' => __('Table', 'luxury-hotel'),
                'name' => 'table',
                'icon' => 'icon-th',
                'categories' => 'commonelements',
            ),
            'tweets' => array(
                'title' => __('Tweets', 'luxury-hotel'),
                'name' => 'tweets',
                'icon' => 'icon-twitter2',
                'categories' => 'loops',
            ),
            'spacer' => array(
                'title' => __('Spacer', 'luxury-hotel'),
                'name' => 'spacer',
                'icon' => 'icon-arrows-v',
                'categories' => 'commonelements',
            ),
            'faq' => array(
                'title' => __('FAQ', 'luxury-hotel'),
                'name' => 'faq',
                'icon' => 'icon-question-circle',
                'categories' => 'typography',
            ),
            'facilities' => array(
                'title' => __('Facilities', 'luxury-hotel'),
                'name' => 'facilities',
                'icon' => 'icon-question-circle',
                'categories' => 'loops misc',
            ),
            'teams' => array(
                'title' => __('Team', 'luxury-hotel'),
                'name' => 'teams',
                'icon' => 'icon-user',
                'categories' => 'loops misc',
            ),
        ...
        if (class_exists('wp_hotel_booking')) {
            $shortcode_array['rooms'] = array(
                'title' => __('Rooms', 'luxury-hotel'),
                'name' => 'rooms',
                'icon' => 'icon-home',
                'categories' => 'loops misc',
            );

            $shortcode_array['room_search'] = array(
                'title' => __('Rooms Search', 'luxury-hotel'),
                'name' => 'room_search',
                'icon' => 'icon-search6',
                'categories' => 'loops misc',
            );
    ...
    function cs_shortcode_popup($die = 0, $shortcode = 'shortcode') {
        ...
        <div class="cs-page-composer  <?php echo sanitize_html_class($shortcode); ?> composer-<?php echo intval($rand) ?>" id="composer-<?php echo intval($rand) ?>" style="display:none">
            <div class="page-elements">
                <div class="cs-heading-area">
                    <h5>
                        <i class="icon-plus-circle"></i> <?php _e('Add Element', 'luxury-hotel'); ?>
                    </h5>
                ...
                <div class="cs-filter-content shortcode">
                    <p><input type="text" id="quicksearch<?php echo intval($rand) ?>" placeholder="<?php _e('Search', 'luxury-hotel'); ?>" /></p>
                    <div class="cs-filtermenu-wrap">
                        <h6><?php _e('Filter by', 'luxury-hotel'); ?></h6>
                        <ul class="cs-filter-menu" id="filters<?php echo intval($rand) ?>">
                            <li data-filter="all" class="active"><?php _e('Show all', 'luxury-hotel'); ?></li>
        <?php
        ...
        <div class="cs-page-composer-shortcode"></div>
            ...
            <a class="button" href="javascript:_createpop('composer-<?php echo esc_js($rand) ?>', 'filter')">
                <i class="icon-plus-circle"></i> <?php _e('CS: Insert shortcode', 'luxury-hotel'); ?></a>
            <?php
        }
    }
...
if (!function_exists('cs_shortcode_element_size')) {
    ...
    function cs_shortcode_element_size($column_size = '') {
        ...
        <ul class="form-elements">
            <li class="to-label"><label><?php _e('Size', 'luxury-hotel'); ?></label></li>
            <li class="to-field select-style">
                <select class="column_size" id="column_size" name="column_size[]">
                    <option value="1/1" <?php if ($column_size == '1/1') {
            echo 'selected="selected"';
        } ?>><?php _e('Full width', 'luxury-hotel'); ?></option>
                    <option value="1/2" <?php if ($column_size == '1/2') {
            echo 'selected="selected"';
        } ?>><?php _e('One half', 'luxury-hotel'); ?></option>
                    <option value="1/3" <?php if ($column_size == '1/3') {
            echo 'selected="selected"';
        } ?>><?php _e('One third', 'luxury-hotel'); ?></option
                    ><option value="2/3" <?php if ($column_size == '2/3') {
            echo 'selected="selected"';
        } ?>><?php _e('Two third', 'luxury-hotel'); ?></option>
                    <option value="1/4" <?php if ($column_size == '1/4') {
                echo 'selected="selected"';
            } ?>><?php _e('One fourth', 'luxury-hotel'); ?></option>
                    <option value="3/4" <?php if ($column_size == '3/4') {
                echo 'selected="selected"';
            } ?>><?php _e('Three fourth', 'luxury-hotel'); ?></option>
                </select>
                <p><?php _e('Select column width. This width will be calculated depend page width', 'luxury-hotel'); ?></p>
            </li>                  
        </ul>
        <?php
    }
...
if (!function_exists('cs_shortcode_custom_classes')) {
    ...
    function cs_shortcode_custom_classes($cs_custom_class = '', $cs_custom_animation = '', $cs_custom_animation_duration = '1') {
        ?>
        <ul class="form-elements">
            <li class="to-label"><label><?php _e('Custom Id', 'luxury-hotel'); ?></label></li>
            <li class="to-field">
                <input type="text" name="cs_custom_class[]" class="txtfield"  value="<?php echo sanitize_text_field($cs_custom_class); ?>" />
                <p><?php _e('Use this option if you want to use specified Class for this element', 'luxury-hotel'); ?></p>
            </li>
        </ul>
        <?php $custom_animation_array = array('fade' => 'Fade', 'slide' => 'Slide', 'left-slide' => 'left Slide'); ?>
        <ul class="form-elements">
            <li class="to-label"><label><?php _e('Animation Class', 'luxury-hotel'); ?><?php echo sanitize_text_field($cs_custom_animation); ?></label></li>
            <li class="to-field select-style">
                <select class="dropdown" name="cs_custom_animation[]">
                    <option value=""><?php _e('Animation Class', 'luxury-hotel'); ?></option>
        <?php
        ...
        ?>
                ...
                <p><?php _e('Select Entrance animation type from the dropdown', 'luxury-hotel'); ?> </p>
            </li>
        </ul>
        <?php
    }
    ...
    function cs_shortcode_custom_dynamic_classes($cs_custom_class = '', $cs_custom_animation = '', $cs_custom_animation_duration = '1', $prefix) {
        ...
        <ul class="form-elements">
            ...
            <li class="to-field">
                ...
                <p><?php _e('Use this option if you want to use specified id for this element', 'luxury-hotel'); ?></p>
            </li>
        </ul>
        <?php $custom_animation_array = array('fade' => 'Fade', 'slide' => 'Slide', 'left-slide' => 'left Slide'); ?>
        <ul class="form-elements">
            ...
            <li class="to-field select-style">
                <select class="dropdown" name="<?php echo sanitize_text_field($prefix); ?>_animation[]">
                    <option value=""><?php _e('Select Animation', 'luxury-hotel'); ?></option>
        <?php
        $animation_array = cs_animation_style();
        foreach ($animation_array as $animation_key => $animation_value) {
            echo '<optgroup label="' . $animation_key . '">';
        ...
        if (isset($_POST['shortcode_element']) && $_POST['shortcode_element']) {
            if ($_POST['shortcode_element'] == 'services') {
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp'  id="cs_infobox_<?php echo intval($rand_id); ?>">
                    <header>
                        <h4>
                            <i class='icon-arrows'></i><?php _e('Service', 'luxury-hotel'); ?>
                        </h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'luxury-hotel'); ?></a>
                    </header>

                <?php if (function_exists('cs_shortcode_element_size')) {
                    cs_shortcode_element_size();
                } ?>
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Service Title', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'> <div class='input-sec'><input class='txtfield' type='text' name='service_title[]' /></div>
                            <div class='left-info'><p><?php _e('Title of the Service', 'luxury-hotel'); ?></p></div>
                        </li>
                    </ul>
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Service View:', 'luxury-hotel'); ?></label></li>
                        <li class='to-field select-style'> <div class='input-sec'><select name='service_type[]' class='dropdown'>
                                    <option value='size_large'><?php _e('Large Boxed', 'luxury-hotel'); ?></option>
                                    <option value='size_large_normal'><?php _e('Large Normal', 'luxury-hotel'); ?></option>
                                    <option value='size_circle'><?php _e('Circle', 'luxury-hotel'); ?></option>
                                    <option  value="size_medium" ><?php _e('Medium', 'luxury-hotel'); ?></option>
                                    <option value='size_small'><?php _e('Small', 'luxury-hotel'); ?></option>
                                </select></div>
                            <div class='left-info'><p><?php _e('Type of the Service', 'luxury-hotel'); ?></p></div>
                        </li>
                    </ul>
                    <ul class='form-elements' id="<?php echo intval($rand_id); ?>">
                        <li class='to-label'><label><?php _e('Font awsome Icon:', 'luxury-hotel'); ?></label></li>
                        <li class="to-field">
                                <?php cs_fontawsome_icons_box('', $rand_id, 'cs_service_icon'); ?>
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Icon Postion', 'luxury-hotel'); ?></label></li>
                        <li class="to-field select-style">
                            <select class="service_icon_postion" name="service_icon_postion[]">
                                <option value="left"><?php _e('left', 'luxury-hotel'); ?></option>
                                <option value="right"><?php _e('Right', 'luxury-hotel'); ?></option>
                                <option value="top"><?php _e('Top', 'luxury-hotel'); ?></option>
                                <option value="center"><?php _e('Center', 'luxury-hotel'); ?></option>
                            </select>
                        </li>                  
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Icon Type', 'luxury-hotel'); ?></label></li>
                        <li class="to-field select-style">
                            <select class="service_icon_type" name="service_icon_type[]">
                                <option value="circle"><?php _e('Circle', 'luxury-hotel'); ?></option>
                                <option value="square"><?php _e('Square', 'luxury-hotel'); ?></option>
                            </select>
                        </li>                  
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Service background  Image', 'luxury-hotel'); ?></label>
                        </li>
                        <li class="to-field">
                            <input id="service_bg_image<?php echo intval($rand_id); ?>" name="service_bg_image[]" type="hidden" class="" value=""/>
                            <input name="service_bg_image<?php echo intval($rand_id); ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'luxury-hotel'); ?>"/>
                        </li>
                    </ul>
                    ...
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Service Link Url:', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'> <div class='input-sec'><input class='txtfield' type='text' name='service_link_url[]' /></div>
                            <div class='left-info'><p><?php _e('Service Link Url', 'luxury-hotel'); ?></p></div>
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Border', 'luxury-hotel'); ?></label></li>
                        <li class="to-field select-style">
                            <select class="service_border" id="service_border" name="service_border[]">
                                <option value="yes"><?php _e('Yes', 'luxury-hotel'); ?></option>
                                <option value="no"><?php _e('No', 'luxury-hotel'); ?></option>
                            </select>
                        </li>                  
                    </ul>
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Service Text:', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'>
                    ...
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Divider', 'luxury-hotel'); ?></label></li>
                        <li class="to-field select-style">
                    ...
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Icon Color', 'luxury-hotel'); ?></label></li>
                        <li class="to-field">
                            <input type="text" name="service_icon_color[]" class="bg_color"  value="" />
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Icon Background Color', 'luxury-hotel'); ?></label></li>
                        <li class="to-field">
                    ...
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Animation Class', 'luxury-hotel'); ?> </label></li>
                        <li class="to-field select-style">
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp'  id="cs_infobox_<?php echo intval($rand_id); ?>">
                    <header>
                        <h4><i class='icon-arrows'></i><?php _e('Accordion', 'luxury-hotel'); ?></h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'luxury-hotel'); ?></a>
                    </header>
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Active', 'luxury-hotel'); ?></label></li>
                        <li class='to-field select-style'>
                            <select name='accordion_active[]'>
                                <option value="no"><?php _e('No', 'luxury-hotel'); ?></option><option value="yes"><?php _e('Yes', 'luxury-hotel'); ?></option>
                            </select>
                            <div class='left-info'>
                                <p><?php _e('You can set the section that is active here by select dropdown', 'luxury-hotel'); ?></p>
                            </div>
                        </li>
                    </ul>
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Accordion Title:', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'>
                                <input class='txtfield' type='text' name='accordion_title[]' />
                            </div>
                            <div class='left-info'>
                                <p><?php _e('Enter accordion title', 'luxury-hotel'); ?></p>
                            </div>
                        </li>
                    </ul>
                    <ul class='form-elements' id="<?php echo intval($rand_id); ?>">
                ...
                <?php cs_fontawsome_icons_box('', $rand_id, 'cs_accordian_icon'); ?>
                            ...
                            <div class='left-info'>
                                <p><?php _e('Select the font awsome Icons you would like to add to your menu items', 'luxury-hotel'); ?></p>
                            </div>
                        </li>
                    </ul>
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Accordion Text:', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'>
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval($rand_id); ?>">
                    <header>
                        <h4><i class='icon-arrows'></i><?php _e('FAQ', 'luxury-hotel'); ?></h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'luxury-hotel'); ?></a>
                    </header>
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Active', 'luxury-hotel'); ?></label></li>
                    ...
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Faq Title:', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'>
                ...
                <?php cs_fontawsome_icons_box('', $rand_id, 'cs_faq_icon'); ?>
                    ...
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Faq Text:', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'>
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp'  id="cs_infobox_<?php echo intval($rand_id); ?>">
                    <header>
                        <h4><i class='icon-arrows'></i><?php _e('Register', 'luxury-hotel'); ?></h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'luxury-hotel'); ?></a>
                    </header>
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Register Title:', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'>
                    ...
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('User Role:', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class="select-style">
                                <select name='register_role[]'>
                                    <option value="<?php _e('subscriber', 'luxury-hotel'); ?>"><?php _e('Subscriber', 'luxury-hotel'); ?></option>
                                    <option value="<?php _e('staff', 'luxury-hotel'); ?>"><?php _e('Staff', 'luxury-hotel'); ?></option>
                                    <option value="<?php _e('member', 'luxury-hotel'); ?>"><?php _e('Member', 'luxury-hotel'); ?></option>
                                    <option value="<?php _e('instructor', 'luxury-hotel'); ?>"><?php _e('Instructor', 'luxury-hotel'); ?></option>
                                    <option value="<?php _e('customer', 'luxury-hotel'); ?>"><?php _e('Customer', 'luxury-hotel'); ?></option>
                                    <option value="<?php _e('contributor', 'luxury-hotel'); ?>"><?php _e('Contributor', 'luxury-hotel'); ?></option>
                                    <option value="<?php _e('author', 'luxury-hotel'); ?>"><?php _e('Author', 'luxury-hotel'); ?></option>
                                    <option value="<?php _e('editor', 'luxury-hotel'); ?>"><?php _e('Editor', 'luxury-hotel'); ?></option>
                                    <option value="<?php _e('administrator', 'luxury-hotel'); ?>"><?php _e('Administrator', 'luxury-hotel'); ?></option>
                                </select>
                            </div>
                        </li>
                    </ul>
                    ...
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Register Text:', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'>
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp add_tabs  cs-pbwp-content'  id="cs_infobox_<?php echo intval($rand_id); ?>">
                    <header>
                        <h4><i class='icon-arrows'></i><?php _e('Tab', 'luxury-hotel'); ?></h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'luxury-hotel'); ?></a>
                    </header>
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Active', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'> 
                            <div class="select-style">
                                <select name='tab_active[]'>
                                    <option value="<?php _e('No', 'luxury-hotel'); ?>"><?php _e('No', 'luxury-hotel'); ?></option>
                                    <option value="<?php _e('yes', 'luxury-hotel'); ?>"><?php _e('Yes', 'luxury-hotel'); ?></option>
                                </select>
                            </div>
                            <div class='left-info'>
                                <p><?php _e('You can set the section that is active here by select dropdown', 'luxury-hotel'); ?></p>
                    ...
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Tab Title:', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'>
                ...
                <?php cs_fontawsome_icons_box('', $rand_id, 'cs_tab_icon'); ?>
                    ...
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Tab Text:', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'>
                                <textarea class='txtfield' data-content-text="cs-shortcode-textarea" name='tab_text[]'></textarea>
                            </div>
                            <div class='left-info'>
                                <p><?php _e('Enter tab body content here', 'luxury-hotel'); ?></p>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content'  id="cs_infobox_<?php echo intval($rand_id); ?>">
                    <header>
                        <h4><i class='icon-arrows'></i><?php _e('Testimonial', 'luxury-hotel'); ?></h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'luxury-hotel'); ?></a>
                    </header>
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Text', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'>
                    ...
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Author', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'><input class='txtfield' type='text' name='testimonial_author[]' /></div>
                        </li>
                    </ul>
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Company:', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'><input class='txtfield' type='text' name='testimonial_company[]' />.</div>
                            <div class='left-info'><p><?php _e('Company Name', 'luxury-hotel'); ?></p></div>
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label">
                        ...
                        <li class="to-field">
                            ...
                            <input name="testimonial_img<?php echo intval($rand_id); ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'luxury-hotel'); ?>"/>
                        </li>
                    </ul>
                    <div class="page-wrap" style="overflow:hidden; display:none" id="testimonial_img<?php echo intval($rand_id); ?>_box" >
                        <div class="gal-active">
                            <div class="dragareamain" style="padding-bottom:0px;">
                                <ul id="gal-sortable">
                                    <li class="ui-state-default" id="">
                                        <div class="thumb-secs"> <img src=""  id="testimonial_img<?php echo intval($rand_id); ?>_img" width="100" height="150" alt="img" />
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval($counter_count); ?>">
                    <header><h4><i class='icon-arrows'></i><?php _e('Counter', 'luxury-hotel'); ?></h4> <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'luxury-hotel'); ?></a></header>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Counter Title', 'luxury-hotel'); ?></label></li>
                        <li class="to-field"><input type="text"  name="counter_title[]"  class="txtfield"  /></li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Type', 'luxury-hotel'); ?></label></li>
                        <li class="to-field">
                            <div class="select-style">
                                <select name="counter_style[]" class="dropdown" >
                                    <option value="one" ><?php _e('Counter Style One', 'luxury-hotel'); ?></option>
                                    <option value="two" ><?php _e('Counter Style Two', 'luxury-hotel'); ?></option>
                                    <option value="three" ><?php _e('Counter Style Three', 'luxury-hotel'); ?></option>
                                    <option value="four" ><?php _e('Counter Style Four', 'luxury-hotel'); ?></option>
                                </select>
                            </div>
                        </li>
                    </ul>
                    ...
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Choose Icon', 'luxury-hotel'); ?></label></li>
                        <li class="to-field">
                            <div class="select-style">
                                <select name="counter_icon_type[]" class="dropdown" onchange="cs_counter_image(this.value, '<?php echo esc_js($counter_count) ?>', '')">
                                    <option <?php if ($counter_item->counter_icon_type == "icon") echo "selected"; ?> value="icon" ><?php _e('Icon', 'luxury-hotel'); ?></option>
                                    <option <?php if ($counter_item->counter_icon_type == "image") echo "selected"; ?> value="image" ><?php _e('Image', 'luxury-hotel'); ?></option>
                                </select>
                            </div>
                        </li>
                    </ul>
                    ...
                    <div class="selected_icon_type" id="selected_icon_type<?php echo intval($counter_count) ?>">
                        <ul class='form-elements' id="<?php echo intval($counter_count); ?>">
                            <li class='to-label'><label><?php _e('Fontawsome Icon', 'luxury-hotel'); ?></label></li>
                            <li class="to-field">
                <?php cs_fontawsome_icons_box('', $counter_count, 'counter_icon'); ?>
                    ...
                    <div class="selected_image_type" id="selected_image_type<?php echo intval($counter_count) ?>" style="display:none">
                        <ul class="form-elements">
                            ...
                            <li class="to-field">
                                ...
                                <input name="cs_counter_logo<?php echo intval($counter_count) ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'luxury-hotel'); ?>"/>
                            </li>
                        </ul>
                    ...
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Background Color', 'luxury-hotel'); ?></label></li>
                        <li><input type="text"  name="counter_bg_color[]" class="bg_color" value="" /></li>
                    </ul>

                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Numbers', 'luxury-hotel'); ?></label></li>
                        <li class="to-field"><input type="text" name="counter_numbers[]" class="txtfield" value="" /></li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Count Text Color', 'luxury-hotel'); ?></label></li>
                        <li><input type="text" name="counter_text_color[]" class="bg_color" /></li>
                    </ul>

                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Link Title', 'luxury-hotel'); ?></label></li>
                        <li class="to-field"><input type="text" name="counter_icon_linktitle[]" class="txtfield" /></li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Link', 'luxury-hotel'); ?></label></li>
                        <li class="to-field"><input type="text" name="counter_icon_linkurl[]" class="txtfield"/></li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Button Color', 'luxury-hotel'); ?></label></li>
            ...
            <?php
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval($rand_id); ?>">
                    ...
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('List Item', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'>
                ...
                ?>
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval($rand_id); ?>">
                    <header><h4><i class='icon-arrows'></i><?php _e('Infobox Item(s)', 'luxury-hotel'); ?></h4>
                        <a href='#' class='deleteit_node'>
                            <i class='icon-minus-circle'></i><?php _e('Remove', 'luxury-hotel'); ?>
                        </a>
                    </header>
                ...
                <?php cs_fontawsome_icons_box('', $rand_id, 'cs_infobox_list_icon'); ?>
                    ...
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Title', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'>
                    ...
                    <ul class='form-elements'>
                        <li class='to-label'><label><?php _e('Short Description', 'luxury-hotel'); ?></label></li>
                        <li class='to-field'>
                            <div class='input-sec'>
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval($rand_id); ?>">
                    <header>
                        <h4><i class='icon-arrows'></i><?php _e('Album Item(s)', 'luxury-hotel'); ?></h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'luxury-hotel'); ?></a>
                    </header>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Track Title', 'luxury-hotel'); ?></label></li>
                        <li class="to-field">
                    ...
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Track MP3 Url', 'luxury-hotel'); ?></label></li>
                        <li class="to-field">
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo cs_allow_special_char($clients_count); ?>">
                    <header>
                        <h4><i class='icon-arrows'></i><?php _e('Client', 'luxury-hotel'); ?></h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'luxury-hotel'); ?></a>
                    </header>
                    <ul class="form-elements">
                        <li class="to-label">
                    ...
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Website Url', 'luxury-hotel'); ?></label></li>
                        <li class="to-field">
                    ...
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Client Logo', 'luxury-hotel'); ?></label>
                        </li>
                        <li class="to-field">
                            <input id="cs_client_logo<?php echo cs_allow_special_char($clients_count) ?>" name="cs_client_logo[]" type="hidden" class="" value=""/>
                            <input name="cs_client_logo<?php echo cs_allow_special_char($clients_count) ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'luxury-hotel'); ?>"/>
                        </li>
                    </ul>
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo cs_allow_special_char($multiple_services_count); ?>">
                    <header>
                        <h4><i class='icon-arrows'></i><?php _e('Multiple Service', 'luxury-hotel'); ?></h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'luxury-hotel'); ?></a>
                    </header>
                    <ul class="form-elements">
                        <li class="to-label">
                    ...
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Multiple Service Logo', 'luxury-hotel'); ?></label>
                        </li>
                        <li class="to-field">
                            ...
                            <input name="cs_multiple_service_logo<?php echo cs_allow_special_char($multiple_services_count) ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'luxury-hotel'); ?>"/>
                        </li>
                    </ul>
                    <div class="page-wrap" style="overflow:hidden; display:<?php echo 'none'; ?>" id="cs_multiple_service_logo<?php echo cs_allow_special_char($multiple_services_count) ?>_box" >
                        <div class="gal-active">
                            <div class="dragareamain" style="padding-bottom:0px;">
                                <ul id="gal-sortable">
                                    <li class="ui-state-default" id="">
                                        <div class="thumb-secs"> <img src="<?php echo cs_allow_special_char($multiple_services_count); ?>"  id="cs_multiple_service_logo<?php echo cs_allow_special_char($multiple_services_count); ?>_img" width="100" height="150"  />
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo cs_allow_special_char($facilities_count); ?>">
                    ...
                    <ul class="form-elements">
                        ...
                        <li class="to-field">
                            ...
                            <input name="image<?php echo cs_allow_special_char($facilities_count) ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'luxury-hotel'); ?>"/>
                        </li>
                    </ul>
                    <div class="page-wrap" style="overflow:hidden; display:<?php echo 'none'; ?>" id="image<?php echo cs_allow_special_char($facilities_count) ?>_box" >
                        <div class="gal-active">
                            <div class="dragareamain" style="padding-bottom:0px;">
                                <ul id="gal-sortable">
                                    <li class="ui-state-default" id="">
                                        <div class="thumb-secs"> <img src="<?php echo cs_allow_special_char($facilities_count); ?>"  id="image<?php echo cs_allow_special_char($facilities_count); ?>_img" width="100" height="150"  />
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content' id="cs_infobox_<?php echo intval($rand_id); ?>">
                    <header>
                        <h4><i class='icon-arrows'></i><?php _e('Progress bars', 'luxury-hotel'); ?></h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'luxury-hotel'); ?></a>
                    </header>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Progress Bars Title', 'luxury-hotel'); ?></label></li>
                        <li class="to-field">
                            <input type="text" name="progressbars_title[]" class="txtfield" value="" />
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Skill (in percentage)', 'luxury-hotel'); ?></label></li>
                        <li class="to-field">
                            ...
                            <p><?php _e('Set the Skill (In %)', 'luxury-hotel'); ?></p>
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"><label><?php _e('Progress Bars Color', 'luxury-hotel'); ?></label></li>
                        <li class="to-field">
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval($offer_count); ?>">
                    <header>
                        <h4><i class='icon-arrows'></i><?php _e('Offer Slider Item', 'luxury-hotel'); ?></h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php _e('Remove', 'luxury-hotel'); ?></a>
                    </header>
                    <ul class="form-elements">
                        <li class="to-label">
                        ...
                        <li class="to-field">
                            ...
                            <input name="cs_slider_image<?php echo intval($offer_count) ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'luxury-hotel'); ?>"/>
                        </li>
                    </ul>
                        ...
                        <div class="gal-active">
                            <div class="dragareamain" style="padding-bottom:0px;">
                                <ul id="gal-sortable">
                                    <li class="ui-state-default" id="">
                                        <div class="thumb-secs">
                                            <img src=""  id="cs_slider_image<?php echo intval($offer_count) ?>_img" width="100" height="150" alt="img"  />
                    ...
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Contents', 'luxury-hotel'); ?></label>
                        </li>
                        <li class="to-field">
                    ...
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Link', 'luxury-hotel'); ?></label>
                        </li>
                        <li class="to-field">
                    ...
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Link Title', 'luxury-hotel'); ?></label>
                        </li>
                        <li class="to-field">
...
function cs_post_attachments($gallery_meta_form) {
    ...
    <div class="to-social-network">
        <div class="gal-active" style="padding-left:0px !important">
            ...
            <div class="dragareamain">
                <div class="placehoder"><?php _e('Gallery is Empty. Please Select Media', 'luxury-hotel'); ?> <img src="<?php echo esc_url(get_template_directory_uri() . '/include/assets/images/bg-arrowdown.png'); ?>" alt="img" />
                </div>
    ...
    ?>
        ...
        <div class="to-social-list">
            <div class="soc-head">
                <h5><?php _e('Select Media', 'luxury-hotel'); ?></h5>
                <div class="right">
...
if (!function_exists('cs_post_flex_slider')) {
    ...
    function cs_post_flex_slider($width, $height, $postid, $view) {
        ...
        foreach ($sliderData as $as_node) {
            ...
            echo '<li>
                                    <figure>
                                        <img src="' . esc_url($image_url) . '" alt="img">';
