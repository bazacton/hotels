		...
		var Data = [
			{ "Class" : "column_100" , "title":"100" , "element" : ["directory","directory_search","gallery", "slider","blog", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "prayer", "advance_search", "parallax","table","call_to_action","flex_column","clients","spacer","heading","testimonials","services","infobox","promobox","offerslider","audio","icons","contactus","tooltip","highlight","list","mesage","faq","members","directory_categories","directory_map","multiple_services","rooms","mailchimp","facilities", "events", "room_search","jobseeker_element"] },
			{ "Class" : "column_75" , "title" : "75" , "element" : ["directory","directory_search","gallery", "slider", "blog", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","tooltip","services","highlight","list","mesage","faq","members","directory_categories","directory_map","multiple_services","mailchimp","facilities", "events", "room_search","rooms"] },
			{ "Class" : "column_67" , "title" : "67" , "element" : ["directory","directory_search","gallery", "slider", "blog", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "pointtable","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","tooltip","highlight","list","services","mesage","faq","members","directory_categories","directory_map","multiple_services","mailchimp","facilities", "events", "room_search","rooms"] },
			{ "Class" : "column_50" , "title" : "50" , "element" : ["directory","directory_search","gallery", "slider", "blog", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable","tabs", "accordion", "advance_search", "prayer","teams","services","table","flex_column","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus","tooltip","highlight","list","mesage","faq","counter","members","directory_categories","directory_map","multiple_services","mailchimp","facilities", "events", "room_search","rooms"] },
			{ "Class" : "column_33" , "title" : "33" , "element" : ["gallery","directory_search", "slider", "blog", "event", "column", "accordions", "message_box",'image', "fixtures", "map", "video", "quote", "dropcap","services", "tabs", "accordion","prayer", "pointtable", "teams","flex_column", "pricetable","spacer","heading","testimonials","infobox","promobox","audio","icons","contactus","tooltip","highlight","list","mesage","faq","directory_map","multiple_services","mailchimp","facilities", "events","table", "room_search","rooms"] },
			{ "Class" : "column_25" , "title" : "25" , "element" : ["gallery","column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable","pastor","services","counter","teams",'services',"flex_column","spacer","heading","testimonials","infobox","promobox","audio","icons","contactus","tooltip","highlight","list","mesage","faq","multiple_services","mailchimp","facilities", "events", "room_search","rooms"] },
		];
		...
		var DataElement = [{"ClassName" : "col_width_full" ,"element" :["gallery", "slider", "blog","spacer", "event", "contact", "parallax", "services", "room_search","rooms"]}];
        ...
        function increment(id){
			...
			var $ = jQuery;		
            var parent,ColumnIndex,CurrentWidget,CurrentColumn,module;
			var parent = $(id).parent('.column-in');
			var parent = $(parent).parent('.column');
            var CurrentColumn = parseInt($(parent).attr('data'));
            var CurrentWidget = $(parent).attr('widget');
            var ColumnIndex = parseInt($(parent).attr('data'));
			var i  = ColumnIndex;
			var c = 0;
            var module = $(parent).attr('item').toString();
				if(ColumnIndex > 0){
				for(i = ColumnIndex - 1; i < Data.length; i--){//
					for(c = 0; c <= Data[i].element.length; c++){
						if(Data[i].element[c] == module ){
