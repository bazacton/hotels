...
if (!function_exists('cs_element_setting')) {
    ...
    function cs_element_setting($name, $cs_counter, $element_size, $element_description = '', $page_element_icon = 'icon-star', $type = '') {
        ...
        $elm_name = ucwords(str_replace('_', ' ', str_replace("cs_pb_", "", $name)));
        if ($elm_name == 'Mailchimp') {
            $elm_name = 'Mail chimp';
        } else if ($elm_name == 'Pricetable') {
            $elm_name = 'Price Table';
        } else if ($elm_name == 'Promobox') {
            $elm_name = 'Promo box';
        } else if ($elm_name == 'Progressbars') {
            $elm_name = 'Progress Bars';
        }
        ?>
        <div class="column-in">
            ...
            <span> <i class="cs-icon <?php echo str_replace("cs_pb_", "", $name); ?>-icon"></i>
                <strong><?php printf(__('%s','luxury-hotel'), $elm_name); ?></strong><br/>
...
if (!function_exists('cs_elements_categories')) {
    ...
    function cs_elements_categories() {
        return array('typography' => __('Typography', 'luxury-hotel'), 'commonelements' => __('Common Elements', 'luxury-hotel'), 'mediaelement' => __('Media Element', 'luxury-hotel'), 'contentblocks' => __('Content Blocks', 'luxury-hotel'), 'loops' => __('Loops', 'luxury-hotel'));
    }
        ...
        <div class="column-in">
            ...
            <span> <i class="cs-icon <?php echo str_replace("cs_pb_", "", $name); ?>-icon"></i>
                <strong>
                    ...
                    $elm_name = ucwords(str_replace('_', ' ', $element_name));
                    if ($elm_name == 'Mailchimp') {
                        $elm_name = 'Mail chimp';
                    } else if ($elm_name == 'Pricetable') {
                        $elm_name = 'Price Table';
                    ...
                    printf(__('%s' , 'luxury-hotel'), $elm_name);
                    ?>
                </strong><br/>
                <?php echo esc_attr($element_description); ?> </span>
        </div>
...
if (!function_exists('cs_column_pb')) {
    ...
    function cs_column_pb($die = 0, $shortcode = '') {
        ...
        <div class="cs-page-composer composer-<?php echo absint($rand) ?>" id="composer-<?php echo absint($rand) ?>" style="display:none">
            <div class="page-elements">
                <div class="cs-heading-area">
                    <h5> <i class="icon-plus-circle"></i><?php _e('Add Element', 'luxury-hotel'); ?>  </h5>
                ...
                <div class="cs-filter-content">
                    <p><input type="text" id="quicksearch<?php echo absint($rand) ?>" placeholder="<?php _e('Search', 'luxury-hotel'); ?>" /></p>
        ...
        if (isset($shortcode) && $shortcode <> '') {
            ?>
            <a class="button" href="javascript:_createpop('composer-<?php echo esc_js($rand) ?>', 'filter')"><i class="icon-plus-circle"></i><?php _e('CS: Insert shortcode', 'luxury-hotel'); ?> </a>
            <?php
        } else {
            ?>
            <div id="<?php echo esc_attr($randomno); ?>_del" class="column columnmain parentdeletesection column_100" >
                <div class="column-in"> <a class="button" href="javascript:_createpop('composer-<?php echo esc_js($rand) ?>', 'filter')"><i class="icon-plus-circle"></i> <?php _e('Add Element', 'luxury-hotel'); ?></a>
                ...
                <div id="<?php echo esc_attr($column_class . $randomno); ?>" style="display:none">
                    <div class="cs-heading-area">
                        <h5><?php _e('Edit Page Section', 'luxury-hotel'); ?></h5>
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            <ul class="form-elements  ">
                                <li class="to-label">
                                    <label><?php _e('Background View', 'luxury-hotel'); ?></label>
                                </li>
                                <li class="to-field">
                                    <div class="input-sec">
                                        <div class="select-style">
                                            <select name="cs_section_background_option[]" class="dropdown" onchange="javascript:cs_section_background_settings_toggle(this.value, '<?php echo absint($randomno); ?>')">
                                                <option <?php if ($cs_section_background_option == 'no-image') echo "selected"; ?> value="no-image"><?php _e('None', 'luxury-hotel'); ?></option>
                                                <option <?php if ($cs_section_background_option == 'section-custom-background-image') echo "selected"; ?> value="section-custom-background-image"><?php _e('Background Image', 'luxury-hotel'); ?></option>
                                                <option <?php if ($cs_section_background_option == 'section-custom-slider') echo "selected"; ?> value="section-custom-slider"><?php _e('Custom Slider', 'luxury-hotel'); ?></option>
                                                <option  <?php if ($cs_section_background_option == 'section_background_video') echo "selected"; ?> value="section_background_video" > <?php _e('Video', 'luxury-hotel'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                            <div class="meta-body noborder section-custom-background-image-<?php echo esc_attr($randomno); ?>" style=" <?php if ($cs_section_background_option == "section-custom-background-image") {
                                echo "display:block";
                                ...
                                <ul class="form-elements noborder">
                                    ...
                                    <li class="to-field">
                                        ...
                                        <input name="cs_section_bg_image<?php echo absint($rand); ?>"  type="button" class="uploadMedia left" value="<?php _e('Browse', 'luxury-hotel'); ?>"/>
                                    </li>
                                </ul>
                                ...
                                <ul class="form-elements noborder">
                                    <li class="to-label">
                                        <label><?php _e('Background Image Position', 'luxury-hotel'); ?></label>
                                    </li>
                                    <li class="to-field">
                                        <div class="input-sec">
                                            <div class="select-style">
                                                <select name="cs_section_bg_image_position[]" class="select_dropdown">
                                                    <option value=""><?php _e('Select position', 'luxury-hotel'); ?></option>
                                                    <option value="left" <?php if ($cs_section_bg_image_position == 'light') echo "selected"; ?>><?php _e('Left', 'luxury-hotel'); ?></option>
                                                    <option value="right" <?php if ($cs_section_bg_image_position == 'right') echo "selected"; ?>><?php _e('Right', 'luxury-hotel'); ?></option>
                                                    <option value="center" <?php if ($cs_section_bg_image_position == 'center') echo "selected"; ?>><?php _e('Center', 'luxury-hotel'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </li>
                                        ...
                                        <div class="input-sec">
                                            <div class="select-style">
                                                <select name="cs_section_bg_image_repeat[]" class="select_dropdown">
                                                    <option value="repeat" <?php if ($cs_section_bg_image_repeat == 'repeat') echo "selected"; ?>><?php _e('Repeat', 'luxury-hotel'); ?></option>
                                                    <option value="no-repeat" <?php if ($cs_section_bg_image_repeat == 'no-repeat') echo "selected"; ?>><?php _e('No Repeat', 'luxury-hotel'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="meta-body noborder section-slider-<?php echo esc_attr($randomno); ?>" style=" <?php if ($cs_section_background_option == "section-slider") {
                                echo "display:block";
                            } else echo "display:none"; ?>" >
                                <?php //cs_section_slider('section_field_name2'); ?>
                            </div>
                            <div class="meta-body noborder section-custom-slider-<?php echo esc_attr($randomno); ?>" style=" <?php if ($cs_section_background_option == "section-custom-slider") {
                                echo "display:block";
                            } else echo "display:none"; ?>" >
                                <ul class="form-elements noborder">
                                    <li class="to-label">
                                        <label><?php _e('Custom Slider', 'luxury-hotel'); ?></label>
                                    </li>
                                    <li class="to-field">
                                        <div class="input-sec">
                            ...
                            <div class="meta-body noborder section-background-video-<?php echo esc_attr($randomno); ?>" style=" <?php if ($cs_section_background_option == "section_background_video") {
                                echo "display:block";
                            } else echo "display:none"; ?>">
                                <ul class="form-elements">
                                    <li class="to-label">
                                        <label><?php _e('Video URL', 'luxury-hotel'); ?></label>
                                    </li>
                                    <li class="to-field">
                                        <div class="input-sec">
                                            ...
                                            <label class="cs-browse">
                                                <input name="cs_section_video_url_<?php echo esc_attr($randomno); ?>" type="button" class="uploadMedia left" value="<?php _e('Browse', 'luxury-hotel'); ?>" />
                                            </label>
                                        </div>
                                        <div class="left-info">
                                            <p><?php _e('Please enter Vimeo/Youtube Video URL', 'luxury-hotel'); ?></p>
                                        </div>
                                    </li>
                                </ul>
                                <ul class="form-elements">
                                    <li class="to-label">
                                        <label><?php _e('Enable Mute', 'luxury-hotel'); ?></label>
                                    </li>
                                    <li class="to-field">
                                        <div class="input-sec">
                                            <div class="select-style">
                                                <select name="cs_section_video_mute[]" class="select_dropdown">
                                                    <option value="yes" <?php if ($cs_section_video_mute == 'yes') echo "selected"; ?>><?php _e('Yes', 'luxury-hotel'); ?></option>
                                                    <option value="no" <?php if ($cs_section_video_mute == 'no') echo "selected"; ?>><?php _e('No', 'luxury-hotel'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </li>
                                ...
                                <ul class="form-elements">
                                    <li class="to-label">
                                        <label><?php _e('Video Auto Play', 'luxury-hotel'); ?></label>
                                    </li>
                                    <li class="to-field">
                                        <div class="input-sec">
                                            <div class="select-style">
                                                <select name="cs_section_video_autoplay[]" class="select_dropdown">
                                                    <option value="yes" <?php if ($cs_section_video_autoplay == 'yes') echo "selected"; ?>><?php _e('Yes', 'luxury-hotel'); ?></option>
                                                    <option value="no" <?php if ($cs_section_video_autoplay == 'no') echo "selected"; ?>><?php _e('No', 'luxury-hotel'); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <ul class="form-elements noborder">
                                <li class="to-label">
                                    <label><?php _e('Enable Parallax', 'luxury-hotel'); ?></label>
                                </li>
                                <li class="to-field">
                                    <div class="input-sec">
                                        <div class="select-style">
                                            <select name="cs_section_parallax[]" class="select_dropdown">
                                                <option value="no" <?php if ($cs_section_parallax == 'no') echo "selected"; ?>><?php _e('No', 'luxury-hotel'); ?></option>
                                                <option value="yes" <?php if ($cs_section_parallax == 'yes') echo "selected"; ?>><?php _e('Yes', 'luxury-hotel'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <ul class="form-elements">
                                <li class="to-label">
                                    <label><?php _e('Select View', 'luxury-hotel'); ?></label>
                                </li>
                                <li class="to-field">
                                    <div class="input-sec">
                                        <div class="select-style">
                                            <select name="cs_section_view[]" class="select_dropdown">
                                                <option value="container" <?php if ($cs_section_view == 'container') echo "selected"; ?>><?php _e('Box', 'luxury-hotel'); ?></option>
                                                <option value="wide" <?php if ($cs_section_view == 'wide') echo "selected"; ?>><?php _e('Wide', 'luxury-hotel'); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <ul class="form-elements">
                                <li class="to-label">
                                    <label><?php _e('Padding Top', 'luxury-hotel'); ?></label>
                                </li>
                                <li class="to-field">
                                    <div class="input-sec">
                                        ...
                                        <p><?php _e('Set the Padding top (In px)', 'luxury-hotel'); ?></p>
                                    </div>
                                </li>
                            </ul>
                            <ul class="form-elements">
                                <li class="to-label">
                                    <label><?php _e('Padding Bottom', 'luxury-hotel'); ?></label>
                                </li>
                                <li class="to-field">
                                    <div class="input-sec">
                                        ...
                                        <p><?php _e('Set the Padding Bottom (In px)', 'luxury-hotel'); ?></p>
                                    </div>
                                </li>
                            </ul>
                            <ul class="form-elements">
                                ...
                                <li class="to-field">
                                    <div class="input-sec">
                                        ...
                                        <p><?php _e('Set the Border Bottom (In px)', 'luxury-hotel'); ?></p>
                                    </div>
                                </li>
                            </ul>
                            <ul class="form-elements">
                                ...
                                <li class="to-field">
                                    <div class="input-sec">
                                        ...
                                        <p><?php _e('Set the Margin Bottom (In px)', 'luxury-hotel'); ?></p>
                                    </div>
                                </li>
                            </ul>
                            <ul class="form-elements">
                                <li class="to-label">
                                    <label><?php _e('Border Top', 'luxury-hotel'); ?></label>
                                </li>
                                <li class="to-field">
                                    <div class="input-sec">
                                        ...
                                        <p><?php _e('Set the Border top (In px)', 'luxury-hotel'); ?></p>
                                    </div>
                                </li>
                            </ul>
                            <ul class="form-elements">
                            ...
                            <ul class="form-elements">
                                <li class="to-label">
                                    <label><?php _e('Border Color', 'luxury-hotel'); ?></label>
                                </li>
                                <li class="to-field">
                                    <div class="input-sec">
                            ...
                            <div class="form-elements elementhiddenn">
                                <ul class="noborder">
                                    <li class="to-label">
                                        <label><?php _e('Select Layout', 'luxury-hotel'); ?></label>
                                    </li>
                                    <li class="to-field">
                                        <div class="meta-input">
                                            <div class="meta-input pattern">
                                                <div class='radio-image-wrapper'>
                                                    ...
                                                    <label for="radio_1<?php echo esc_attr($randomno) ?>"> <span class="ss"><img src="<?php echo esc_url(get_template_directory_uri() . '/include/assets/images/no_sidebar.png') ?>"  alt="img" /></span> <span <?php if ($cs_layout == "none") echo "class='check-list'" ?> id="check-list"></span> </label>
                                                </div>
                                                <div class='radio-image-wrapper'>
                                                    ...
                                                    <label for="radio_2<?php echo esc_attr($randomno) ?>"> <span class="ss"><img src="<?php echo esc_url(get_template_directory_uri() . '/include/assets/images/sidebar_right.png') ?>" alt="img" /></span> <span <?php if ($cs_layout == "right") echo "class='check-list'" ?> id="check-list"></span> </label>
                                                </div>
                                                <div class='radio-image-wrapper'>
                                                    ...
                                                    <label for="radio_3<?php echo esc_attr($randomno); ?>"> <span class="ss"><img src="<?php echo esc_url(get_template_directory_uri() . '/include/assets/images/sidebar_left.png'); ?>" alt="img" /></span> <span <?php if ($cs_layout == "left") echo "class='check-list'" ?> id="check-list"></span> </label>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                                <ul class="meta-body" style=" <?php if ($cs_layout == "left") {
                                    echo "display:block";
                                } else echo "display:none"; ?>" id="<?php echo esc_attr($randomno); ?>_sidebar_left" >
                                    <li class="to-label">
                                        <label><?php _e('Select Left Sidebar', 'luxury-hotel'); ?></label>
                                    </li>
                                    <li class="to-field">
                                        ...
                                        <p> <?php _e('Add New Sidebar', 'luxury-hotel'); ?> <a href="<?php echo admin_url(); ?>themes.php?page=cs_theme_options#tab-manage-sidebars-show" target="_blank"><?php _e('Click Here', 'luxury-hotel'); ?></a></p>
                                    </li>
                                </ul>
                                <ul class="meta-body" style=" <?php if ($cs_layout == "right") {
                                    echo "display:block";
                                } else echo "display:none"; ?>" id="<?php echo esc_attr($randomno); ?>_sidebar_right" >
                                    <li class="to-label">
                                        <label><?php _e('Select Right Sidebar', 'luxury-hotel'); ?></label>
                                    </li>
                                    <li class="to-field">
                                        ...
                                        <p>><?php _e('Add New Sidebar', 'luxury-hotel'); ?>  <a href="<?php echo esc_url(admin_url('themes.php?page=cs_theme_options#tab-manage-sidebars-show')); ?>" target="_blank"><?php _e('Click Here', 'luxury-hotel'); ?></a></p>
                                    </li>
                                </ul>
                            </div>
                            <ul class="form-elements noborder">
                                ...
                                <li class="to-field">
                                    <input type="button" value="<?php _e('Save', 'luxury-hotel'); ?>" style="margin-right:10px;" onclick="javascript:removeoverlay('<?php echo esc_js($column_class . $randomno); ?>', 'filterdrag')" />
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    function media_pagination($id = '', $func = 'clone') {
        ...
        <ul class="gal-list">
            ...
            foreach ($query_images->posts as $image) {
                ...
                ?>
                <li style="cursor:pointer"><img src="<?php echo esc_url($image_path[0]); ?>" onclick="javascript:<?php echo esc_attr($func); ?>('<?php echo esc_js($image->ID) ?>', 'gal-sortable-<?php echo esc_js($id); ?>')" alt="img" /></li>
            <?php } ?>
        </ul>
        <br />
    ...
    function cs_slider_media_pagination($id = '', $func = 'clone') {
        ...
        <ul class="gal-list">
            ...
            foreach ($query_images->posts as $image) {
                $image_path = wp_get_attachment_image_src($image->ID, array(get_option("thumbnail_size_w"), get_option("thumbnail_size_h")));
                ?>
                <li style="cursor:pointer"><img src="<?php echo esc_url($image_path[0]); ?>" onclick="javascript:slider('<?php echo esc_js($image->ID) ?>', 'gal-sortable-<?php echo esc_js($id); ?>')" alt="img" /></li>
            <?php } ?>
        </ul>
        <br />
        <div class="pagination-cus">
    ...
    function cs_slider_clone() {
        ...
        <li class="ui-state-default" id="<?php echo esc_attr($cs_counter) ?>">
            <div class="thumb-secs">
                ...
                <img src="<?php echo esc_url($image_path[0]) ?>" alt="img">
            ...
            <div class="poped-up" id="edit_<?php echo esc_attr($cs_counter) ?>">
                <div class="cs-heading-area">
                    <h5><?php _e('Edit Options', 'luxury-hotel'); ?></h5>
                ...
                <div class="cs-pbwp-content">
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Image Title', 'luxury-hotel'); ?></label>
                        </li>
                        <li class="to-field">
                    ...
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Image Description', 'luxury-hotel'); ?></label>
                        </li>
                        <li class="to-field">
                    ...
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Link Target', 'luxury-hotel'); ?></label>
                        </li>
                        <li class="to-field">
                            ...
                            <p><?php _e('Please select image target', 'luxury-hotel'); ?></p>
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"></li>
        ...
        <li class="ui-state-default" id="<?php echo esc_attr($cs_counter); ?>">
            ...
            <div class="poped-up" id="edit_<?php echo esc_attr($cs_counter); ?>">
                ...
                <div class="cs-pbwp-content">
                    ...
                    <ul class="form-elements">
                        <li class="to-label">
                            <label><?php _e('Use Image As', 'luxury-hotel'); ?></label>
                        </li>
                        <li class="to-field">
                            <select name="<?php echo esc_attr($clone_field_name); ?>use_image_as[]" class="select_dropdown" onchange="cs_toggle_gal(this.value, <?php echo esc_js($cs_counter) ?>)">
                                <option <?php if ($cs_node['use_image_as'] == "0") echo "selected"; ?> value="0"><?php _e('LightBox to current thumbnail', 'luxury-hotel'); ?></option>
                                <option <?php if ($cs_node['use_image_as'] == "1") echo "selected"; ?> value="1"><?php _e('LightBox to Video', 'luxury-hotel'); ?></option>
                                <option <?php if ($cs_node['use_image_as'] == "2") echo "selected"; ?> value="2"><?php _e('Link URL', 'luxury-hotel'); ?></option>
                            </select>
                            <p><?php _e('Please select Image link where it will go', 'luxury-hotel'); ?></p>
                        </li>
                    </ul>
                    <ul class="form-elements" id="video_code<?php echo esc_attr($cs_counter); ?>" <?php if ($cs_node['use_image_as'] == "0" or $cs_node['use_image_as'] == "" or $cs_node['use_image_as'] == "2") echo 'style="display:none"'; ?> >
                        ...
                        <li class="to-field">
                            ...
                            <p><?php _e('Enter Specific Video URL Youtube or Vimeo', 'luxury-hotel'); ?></p>
                        </li>
                    </ul>
                    <ul class="form-elements" id="<?php echo esc_attr($clone_field_name); ?>link_url<?php echo esc_attr($cs_counter) ?>" <?php if ($cs_node['use_image_as'] == "0" or $cs_node['use_image_as'] == "" or $cs_node['use_image_as'] == "1") echo 'style="display:none"'; ?> >
                        <li class="to-label">
                            <label><?php _e('Link URL', 'luxury-hotel'); ?></label>
                        </li>
                        <li class="to-field">
                            ...
                            <p><?php _e('Enter Specific Link URL', 'luxury-hotel'); ?></p>
                        </li>
                    </ul>
                    <ul class="form-elements">
                        <li class="to-label"></li>
...
if (!function_exists('cs_add_social_icon')) {
    ...
    function cs_add_social_icon() {
        ...
        if (isset($icon_awesome) and $icon_awesome <> '') {
            ...
            ;
            echo '<img width="50" src="' . $_POST['social_net_icon_path'] . '">';
        }echo '</td> 
        ...
        echo '<tr id="' . str_replace(' ', '-', $_POST['social_net_tooltip']) . '" style="display:none">
                ...
                <li><a onclick="cs_toggle(\'' . str_replace(' ', '-', $_POST['social_net_tooltip']) . '\')"><img src="' . get_template_directory_uri() . '/include/assets/images/close-red.png" /></a></li>
                  <li class="to-label">
                      <label>"' . __('Title', 'luxury-hotel') . '"</label>
                    </li>
                    <li class="to-field">
                      <input class="small" type="text" id="social_net_tooltip" name="social_net_tooltip[]" value="' . $_POST['social_net_tooltip'] . '"  />
                      <p>__("Please enter text for icon tooltip","luxury-hotel").</p>
                    </li>
                    <li class="to-label">
                      <label>"' . __('Url', 'luxury-hotel') . '"</label>
                    </li>
                    <li class="to-field">
                      <input class="small" type="text" id="social_net_url" name="social_net_url[]" value="' . $_POST['social_net_url'] . '"/>
                      <p>"' . __('Please enter full Url', 'luxury-hotel') . '"</p>
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                      <label>"' . __('Icon Path', 'luxury-hotel') . '"</label>
                    </li>
                    <li class="to-field">
                      ...
                      <label class="browse-icon"><input id="social_net_icon_path' . $counter_icon . '" name="social_net_icon_path' . $i . '" type="button" class="uploadMedia left" value="' . __('Browse', 'luxury-hotel') . '"/></label>
                    </li>
                    
                    <li style="padding: 10px 0px 20px;" class="full">
                       <ul id="cs_infobox_networks' . $counter_icon . '">
                          <li class="to-label">
                            <label>"' . __('Fontawsome Icon', 'luxury-hotel') . '"</label>
                          </li>
                    ...
                    <li class="to-label">
                      <label>"' . __('Font Awesome Color', 'luxury-hotel') . '"<span></span></label>
                    </li>
                    <li class="to-field">
                      <div class="input-sec">
...
if (!function_exists('cs_add_banner_fields')) {
    ...
    function cs_add_banner_fields() {
        ...
        if ($_POST['banner_field_type'] == 'image') {
            echo '<td><img src="' . $_POST['banner_field_image'] . '" alt="img" width="100" /></td>';
        } else {
        ...
        echo '<tr id="' . cs_slugify_text($_POST['banner_field']) . '" style="display:none;">
                <td colspan="3">
                  <ul class="form-elements">
                    <li><a onclick="cs_toggle(\'' . cs_slugify_text($_POST['banner_field']) . '\')"><img src="' . get_template_directory_uri() . '/include/assets/images/close-red.png" /></a></li>
                    <li class="to-label">
                      <label>"' . __('Title', 'luxury-hotel') . '"</label>
                    </li>
                    <li class="to-field">
                      <input class="small" type="text" name="banner_field_title[]" value="' . $_POST['banner_field'] . '"  />
                      <p>"' . __('Please enter Banner Title', 'luxury-hotel') . '"</p>
                    </li>
                    <li class="to-label">
                      <label>"' . __('Banner Style', 'luxury-hotel') . '"</label>
                    </li>
                    <li class="to-field select-style">
                      <select name="banner_field_style[]">
                        <option ' . $cs_top_banner_selected . ' value="top_banner">"' . __('Top Banner', 'luxury-hotel') . '"</option>
                        <option ' . $cs_bottom_banner_selected . ' value="bottom_banner">"' . __('Bottom Banner', 'luxury-hotel') . '"</option>
                        <option ' . $cs_sidebar_banner_selected . ' value="sidebar_banner">"' . __('Sidebar Banner', 'luxury-hotel') . '"</option>
                        <option ' . $cs_vertical_banner_selected . ' value="vertical_banner">"' . __('Vertical Banner', 'luxury-hotel') . '"</option>
                      </select>
                      <p>"' . __('Please enter Banner Banner Style', 'luxury-hotel') . '"</p>
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                      <label>"' . __('Banner Type', 'luxury-hotel') . '"</label>
                    </li>
                    <li class="to-field select-style">
                      ...
                      <p>"' . __('Please enter Banner Banner Type', 'luxury-hotel') . '"</p>
                    </li>
                    <li class="full">&nbsp;</li>
                    ...
                    <li class="to-field" id="cs_banner_image_value_' . $cs_rand_id . '" style="display:' . $cs_baner_image_display . ';">
                      <ul class="form-elements" id="' . $cs_rand_id . '_upload">
                        <li class="to-field">
                          ...
                          <input name="banner_field_image' . $cs_rand_id . '" type="button" class="uploadMedia left" value="' . __('Browse', 'luxury-hotel') . '"/></label>
                        </li>
                      </ul>
                          ...
                          <div class="dragareamain" style="padding-bottom:0px;">
                            <ul id="gal-sortable">
                              <li class="ui-state-default">
                                <div class="thumb-secs"> <img src="' . $_POST['banner_field_image'] . '" id="banner_field_image' . $cs_rand_id . '_img" width="100" />
                      ...
                      <p>"' . __('Please enter Banner Image', 'luxury-hotel') . '"</p>
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                      <label>"' . __('URL', 'luxury-hotel') . '"</label>
                    ...
                    <li class="to-field">
                      ...
                      <p>"' . __('Please enter Banner URL', 'luxury-hotel') . '"</p>
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
                      <label>"' . __('Target', 'luxury-hotel') . '"</label>
                    </li>
                    <li class="to-field select-style">
                      <select name="banner_field_url_target[]">
                        <option ' . $cs_self_target_selected . ' value="_self">"' . __('Self', 'luxury-hotel') . '"</option>
                        <option ' . $cs_blank_target_selected . ' value="_blank">"' . __('Blank', 'luxury-hotel') . '"</option>
                      </select>
                      <p>"' . __('Please select Banner Link Target', 'luxury-hotel') . '"</p>
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label" id="cs_banner_code_field_' . $cs_rand_id . '" style="display:' . $cs_baner_code_display . ';">
                      <label>"' . __('Adsense Code', 'luxury-hotel') . '"</label>
                    </li>
                    <li class="to-field" id="cs_banner_code_value_' . $cs_rand_id . '" style="display:' . $cs_baner_code_display . ';">
                      <textarea name="banner_adsense_code[]">' . wp_specialchars_decode($_POST['banner_field_code']) . '</textarea>
                      <p>"' . __('Please enter Banner Adsense', 'luxury-hotel') . '" Code.</p>
                    </li>
                    <li class="full">&nbsp;</li>
