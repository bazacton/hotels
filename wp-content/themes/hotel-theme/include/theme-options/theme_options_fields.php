            ...
            switch ($value['type']) {
                ...
                case "announcement":
                    ...
                    $output.='<div id="' . $value['id'] . '" class="alert alert-info fade in nomargin theme_box">
                                        ...
                                        <h4>' . force_balance_tags(cs_data_validation($value['name'])) . '</h4>
                                        <p>' . force_balance_tags(cs_data_validation($value['std'])) . '</p>
                             </div>';
                    break;
                ...
                case 'export':
                    ...
                    $cs_export_options_encode = '';
                    if(function_exists('base_64_encode')) {
                        $cs_export_options_encode =  base_64_encode(serialize($cs_export_options));
                    }
                    $output .= '<ul class="form-elements">
                                    <li class="to-label">
                                        <label>' . esc_attr($value['name']) . '<span>' . esc_attr($value['hint_text']) . '</span></label>
                                    ...
                                    <li class="to-field">
                                        <div class="input-sec">
                                            <textarea rows="30" cols="60" name="' . $value['id'] . '" id="' . $value['id'] . '" type="' . $value['type'] . '" readonly="readonly">' . $cs_export_options_encode . '</textarea>
                                        </div>
                                        <div class="left-info"><p>' . esc_attr($value['desc']) . '</p></div>
                                    </li>
                              </ul>';
                ...
                case 'gfont_select':
                    ...
                    $output .='<option value="default">' . __('Default Font', 'luxury-hotel') . '</option>';
                    $i = 0;
                    foreach ($value['options'] as $key => $option) {
                        $selected = '';
                        if ($select_value != '') {
                    ...
                    $output .='<ul class="form-elements" id="' . $value['id'] . '_select">
                                <li class="to-label"><label>' . esc_attr($value['name']) . '<span>' . esc_attr($value['hint_text']) . '</span></label></li>
                                    ...
                                    <div class="input-sec">
                                        <div class="select-style">
                                        <select name="' . $value['id'] . '" id="' . $value['id'] . '">
                                        <option value="">' . __('Select Attribute', 'luxury-hotel') . '</option>';
                ...
                case "upload":
                    ...
                    $output .= '<ul class="form-elements" id="' . $value['id'] . '_upload">
                                  ...
                                  <li class="to-field">
                                    ...
                                    <input name="' . $value['id'] . '"  type="button" class="uploadMedia left" value="' . __('Browse', 'luxury-hotel') . '"/></label>
                                  </li>
                                </ul>';
                ...
                case "upload logo":
                    ...
                    $output .= '<ul class="form-elements" id="' . $value['id'] . '_upload">
                                  ...
                                  <li class="to-field">
                                    ...
                                    <input id="' . $value['id'] . '" name="' . $value['id'] . '" type="hidden" class="" value="' . $val . '"/>
                                    <label class="browse-icon"><input name="' . $value['id'] . '"  type="button" class="uploadMedia left" value="' . __('Browse', 'luxury-hotel') . '"/></label>
                                  </li>
                                </ul>';
                ...
                case "upload font":
                    ...
                    $output .= '<ul class="form-elements" id="' . $value['id'] . '_upload">
                                  ...
                                  <li class="to-field">
                                    ...
                                    <label class="browse-icon">
                                        <input name="' . $value['id'] . '" type="button" class="uploadMedia left" value="' . __('Browse', 'luxury-hotel') . '"/>
                                    </label>
                                  </li>
                                </ul>';
                    break;
                ...
                case "upload favicon":
                    ...
                    $output .= '<label class="cs-browse"><input id="log" name="' . $value['id'] . '" type="button" class="uploadfile left" value="' . __('Browse', 'luxury-hotel') . '"/><i class="icon-upload"></i></label></div></li></ul>';
                ...
                case "sidebar":
                    ...
                    $output .= '<ul class="form-elements">
                                    <li class="to-label">
                                        <label>' . esc_attr($value['name']) . ' <span>' . __("Please enter the desired title of sidebar", 'luxury-hotel') . '</span></label>
                                    </li>
                                    <li class="to-field">
                                        <input class="small" type="text" name="sidebar_input" id="sidebar_input"/>
                                        <input type="button" value=' . __("Add Sidebar", 'luxury-hotel') . ' onclick="javascript:add_sidebar()" />
                                    </li>
                                </ul>
                                <div class="clear"></div>
                                <div class="sidebar-area" style="display:' . $display . '">
                                    <div class="theme-help">
                                      <h4 style="padding-bottom:0px;">' . __('Already Added Sidebars', 'luxury-hotel') . '</h4>
                                      <div class="clear"></div>
                                    </div>
                                    <div class="boxes">
                                        ...
                                        <thead>
                                            <tr>
                                                <th>' . __('Sider Bar Name', 'luxury-hotel') . '</th>
                                                <th class="centr">' . __("Actions", 'luxury-hotel') . '</th>
                                            </tr>
                                        </thead>
                ...
                case "networks":
                    ...
                    $output.='<ul class="form-elements">
                                <li class="to-label">
                                  <label>' . __("Title", 'luxury-hotel') . ' <span>' . __("Please enter text for icon", "luxury-hotel") . '</span></label>
                                </li>
                                <li class="to-field">
                                ...
                                <li class="full">&nbsp;</li>
                                <li class="to-label">
                                  <label>' . __("Url", 'luxury-hotel') . ' <span>' . __("Please enter Full Url", "luxury-hotel") . '</span></label>
                                </li>
                                <li class="to-field">
                                ...
                                <div class="input-sec">
                                  ...
                                  <label class="browse-icon"><input id="social_net_icon_path_input" name="social_net_icon_path_input" type="button" class="uploadMedia left" value="' . __('Browse', 'luxury-hotel') . '"/></label>
                               </li>
                              ...
                              <li class="to-label">
                                <label>' . __('FontAwesome Color', 'luxury-hotel') . '<span></span></label>
                              </li>
                              <li class="to-field">
                                <div class="input-sec">
                                ...
                                <li class="to-field" style="width:100%;">
                                  <input type="button" value="' . __("Add", 'luxury-hotel') . '" onclick=javascript:cs_add_social_icon("' . admin_url("admin-ajax.php") . '") style="float:right;" />
                                </li>
                              </ul>
                              <div class="clear"></div>
                              <div class="social-area" style="display:' . $display . '">
                              <div class="theme-help">
                                <h4 style="padding-bottom:0px;">' . __("Already Added Social Icons", 'luxury-hotel') . '</h4>
                                <div class="clear"></div>
                              </div>
                              <div class="boxes">
                              <table class="to-table" border="0" cellspacing="0">
                                  <thead>
                                    <tr>
                                      <th>' . __("Icon Path", 'luxury-hotel') . '</th>
                                      <th>' . __("Network Name", 'luxury-hotel') . '</th>
                                      <th>' . __("Url", 'luxury-hotel') . '</th>
                                      <th class="centr">' . __("Actions Icon", 'luxury-hotel') . '</th>
                                    </tr>
                                  </thead>
                                ...
                                $output.='<tr id="' . str_replace(' ', '-', $social_net_tooltip[$i]) . '" style="display:none">
                                                      ...
                                                      <li><a onclick="cs_toggle(\'' . str_replace(' ', '-', $social_net_tooltip[$i]) . '\')"><img src="' . get_template_directory_uri() . '/include/assets/images/close-red.png" /></a></li>
                                                          ...
                                                          <li class="to-field">
                                                            ...
                                                            <label class="browse-icon"><input id="social_net_icon_path' . $i . '" name="social_net_icon_path' . $i . '" type="button" class="uploadMedia left" value="' . __('Browse', 'luxury-hotel') . '"/></label>
                                                          </li>
                                                          ...
                                                          <li class="to-label">
                                                            <label>' . __("Font Awesome Color", 'luxury-hotel') . '</label>
                                                          </li>
                                                          <li class="to-field">
                                                            <div class="input-sec">
                ...
                case "banner_fields":
                    ...
                    $output.='<ul class="form-elements">
                                <li class="to-label">
                                  <label>' . __('Title', 'luxury-hotel') . ' <span>' . __('Please enter Banner Title', 'luxury-hotel') . '</span></label>
                                </li>
                                <li class="to-field">
                                ...
                                <li class="full">&nbsp;</li>
                                <li class="to-label">
                                  <label>' . __('Banner Style', 'luxury-hotel') . '<span>' . __('Please enter Banner Banner Style', 'luxury-hotel') . '</span></label>
                                </li>
                                <li class="to-field select-style">
                                  <select id="banner_style_input">
                                    <option value="top_banner">' . __('Top Banner', 'luxury-hotel') . '</option>
                                    <option value="bottom_banner">' . __('Bottom Banner', 'luxury-hotel') . '</option>
                                    <option value="sidebar_banner">' . __('Sidebar Banner', 'luxury-hotel') . '</option>
                                    <option value="vertical_banner">' . __('Vertical Banner', 'luxury-hotel') . '</option>
                                  </select>
                                </li>
                                <li class="full">&nbsp;</li>
                                <li class="to-label">
                                  <label>' . __('Banner Type', 'luxury-hotel') . ' <span>' . __('Please enter Banner Banner Type', 'luxury-hotel') . '</span></label>
                                </li>
                                <li class="to-field select-style">
                                  <select id="banner_type_input" onchange="cs_banner_type_toggle(this.value, \'' . $cs_rand_id . '\')">
                                    <option value="image">' . __('Image', 'luxury-hotel') . '</option>
                                    <option value="code">' . __('Code', 'luxury-hotel') . '</option>
                                  </select>
                                </li>
                                <li class="full">&nbsp;</li>
                                <li class="to-label" id="cs_banner_image_field_' . $cs_rand_id . '">
                                  <label>' . __('Image', 'luxury-hotel') . ' <span>' . __('Please enter Banner Image', 'luxury-hotel') . '</span></label>
                                </li>
                                  ...
                                  <div class="page-wrap" style="overflow:hidden;display:none" id="banner_field_image' . $cs_rand_id . '_box" >
                                    <div class="gal-active" style="padding-left:0 !important;">
                                      <div class="dragareamain" style="padding-bottom:0px;">
                                        <ul id="gal-sortable">
                                          <li class="ui-state-default" id="">
                                            <div class="thumb-secs"> <img src="" id="banner_field_image' . $cs_rand_id . '_img" alt="img"  />
                                ...
                                <li class="full">&nbsp;</li>
                                <li class="to-label">
                                  <label>' . __('Url', 'luxury-hotel') . ' <span>' . __('Please enter Banner Url', 'luxury-hotel') . '</span></label>
                                </li>
                                <li class="to-field">
                                ...
                                <li class="full">&nbsp;</li>
                                <li class="to-label">
                                  <label>' . __('Target', 'luxury-hotel') . ' <span>' . __('Please selct Banner Link Target', 'luxury-hotel') . '</span></label>
                                </li>
                                <li class="to-field select-style">
                                  <select id="banner_field_url_target_input">
                                    <option value="_self">' . __('Self', 'luxury-hotel') . '</option>
                                    <option value="_blank">' . __('Blank', 'luxury-hotel') . '</option>
                                  </select>
                                </li>
                                <li class="full">&nbsp;</li>
                                <li class="to-label" id="cs_banner_code_field_' . $cs_rand_id . '" style="display:none;">
                                  <label>' . __('Adsense Code', 'luxury-hotel') . ' <span>' . __('Please enter Banner Adsense Code', 'luxury-hotel') . '</span></label>
                                </li>
                                ...
                                <li class="to-field" style="width:100%;">
                                  ...
                                  <input type="button" value="' . __('Add', 'luxury-hotel') . '" onclick=javascript:cs_add_banner_fields("' . admin_url("admin-ajax.php") . '","' . esc_js(get_template_directory_uri()) . '","' . $cs_rand_id . '") style="float:right;" />
                                </li>
                              </ul>
                              <div class="clear"></div>
                              <div class="banner-fields-area" style="display:' . $display . '">
                              <div class="theme-help">
                                <h4 style="padding-bottom:0px;">' . __('Already Added Banners', 'luxury-hotel') . '</h4>
                                <div class="clear"></div>
                              </div>
                              <div class="boxes">
                              <table class="to-table" border="0" cellspacing="0">
                                  <thead>
                                    <tr>
                                      <th>' . __('Title', 'luxury-hotel') . '</th>
                                      <th>' . __('Style', 'luxury-hotel') . '</th>
                                      <th>' . __('Image', 'luxury-hotel') . '</th>
                                      <th>' . __('Clicks', 'luxury-hotel') . '</th>
                                      <th>' . __('Shortcode', 'luxury-hotel') . '</th>
                                    </tr>
                                  </thead>
                            ...
                            if (isset($banner_fields[$i]) || isset($banner_fields[$i])) {
                                ...
                                if ($banner_fields_type[$i] == 'image') {
                                    if ($banner_fields_image[$i] <> '') {
                                        $output .= '<td><img src="' . $banner_fields_image[$i] . '" alt="img" width="100" /></td>';
                                    } else {
                                        $output .= '<td>&nbsp;</td>';
                                    }
                                } else {
                                ...
                                $output.='<tr id="' . cs_slugify_text($banner_fields[$i]) . '" style="display:none">
                                          ...
                                          <li><a onclick="cs_toggle(\'' . cs_slugify_text($banner_fields[$i]) . '\')"><img src="' . get_template_directory_uri() . '/include/assets/images/close-red.png" /></a></li>
                                              ...
                                              <li class="full">&nbsp;</li>
                                              <li class="to-label">
                                                <label>' . __('Banner Style', 'luxury-hotel') . ' <span>' . __('Please enter Banner Style', 'luxury-hotel') . '</span></label>
                                              </li>
                                              <li class="to-field select-style">
                                              ...
                                              <li class="to-field select-style">
                                                <select name="banner_field_type[]" onchange="cs_banner_type_toggle(this.value, \'' . $cs_rand_id . '\')">
                                                  <option ' . $cs_image_banner_selected . ' value="image">' . __('Image', 'luxury-hotel') . '</option>
                                                  <option ' . $cs_code_banner_selected . ' value="code">' . __('Code', 'luxury-hotel') . '</option>
                                                </select>
                                              ...
                                              <li class="to-label" id="cs_banner_image_field_' . $cs_rand_id . '" style="display:' . $cs_baner_image_display . ';">
                                                <label>' . __('Image', 'luxury-hotel') . '</label>
                                              </li>
                                              <li class="to-field" id="cs_banner_image_value_' . $cs_rand_id . '" style="display:' . $cs_baner_image_display . ';">
                                                <ul class="form-elements" id="' . $i . '_upload">
                                                  <li class="to-field">
                                                    ...
                                                    <label class="browse-icon">
                                                    <input name="banner_field_image' . $i . '" type="button" class="uploadMedia left" value="' . __('Browse', 'luxury-hotel') . '"/></label>
                                                  </li>
                                                </ul>
                                              ...
                                              <li class="to-field" id="cs_banner_code_value_' . $cs_rand_id . '" style="display:' . $cs_baner_code_display . ';">
                                                <textarea name="banner_adsense_code[]">' . wp_specialchars_decode($banner_fields_code[$i]) . '</textarea>
                                                <p>' . __('Please enter Banner Adsense Code', 'luxury-hotel') . '</p>
                                              </li>
                                              <li class="full">&nbsp;</li>
